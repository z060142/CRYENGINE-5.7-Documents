...
The **"display_name"** is similar to what you can define inside the item scripts themselves and is referenced by the [localization system](/docs/static/engines/cryengine-3/categories/1114113/pages/1310919).
