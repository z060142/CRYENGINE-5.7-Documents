...
In Sandbox, it is possible to link an entity to other entities. More information on this feature can be found in the Sandbox Manual under [Grouping and Linking Objects](/docs/static/engines/cryengine-3/categories/1114113/pages/1048819).
...
The ScriptBind functions related to Entity Links are listed in [ScriptBind_Entity](../../../CRYENGINE%20API%20Reference/ScriptBind%20Reference/CRYENGINE%20Functions/ScriptBind_Entity.md).
