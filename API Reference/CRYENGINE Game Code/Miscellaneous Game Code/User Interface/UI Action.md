...
After introducing the concept of a [UI Element](UI%20Element.md) in CRYENGINE, the next step is to review what we can actually do with these elements. Let us now introduce you to the concept of an UI Action.
...
One way to use the functionality of the UI elements is to directly use the exposed functions / events in your level [Flowgraph (MANUAL)](/docs/static/engines/cryengine-5/categories/23756813/pages/23306550). This isn't an optimal approach for development. It maybe good for prototyping and quick testing of features, but it has some downsides:
