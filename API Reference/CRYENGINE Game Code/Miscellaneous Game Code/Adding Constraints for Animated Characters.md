...
From CRYENGINE 5.2, one can now use constraints (
including self-constraints
) with character/live skeletons.

If the constraint is not supposed to
 affect the character's animation, the skeleton's mass must be set to 0.
