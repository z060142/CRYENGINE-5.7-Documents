...
If you've [HowDoIRunFeatureTestsFromTheCommandLine?](How%20to%20Run%20Feature%20Tests.md#HowtoRunFeatureTests-HowDoIRunFeatureTestsFromTheCommandLine%3F) the game will generate one or more XML report files containing your results in a folder called, appropriately enough, "Xml-Reports". You can open these files in a text editor or a browser.
