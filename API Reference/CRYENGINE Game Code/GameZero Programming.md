...
Assuming you are familiar with the [Getting Started with Game Code](Getting%20Started%20with%20Game%20Code.md) guide and the basic concept behind [GameZero](/docs/static/engines/cryengine-5/categories/23756813), select **[GameZero] Profile, x64** from the configuration settings to compile ** CryGameZero.dll**
