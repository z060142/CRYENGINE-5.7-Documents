...
arguments
 |
arguments to pass to this action.
 |
...
eventName
 |
Name of the event that is fired from the UI Element - if empty string it will receive all events!
 |

callbackFunctionName
 |
name of the script function that will receive the callback.
 |
...
eventName
 |
Name of the event that is fired from the UI Action (can be "OnStart" or "OnEnd") - if empty string it will receive all events!
 |
...
eventSystem
 |
UI Event System name
 |

eventName
 |
Name of the event that is fired from the UI EventSystem - if empty string it will receive all events!
 |
