...
API
 |
Cry::GamePlatform::IService::GetApplicationId
 |

Flow Graph Nodes
 |
GamePlatform:General:ApplicationId
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::General::GetApplicationId
 |
...
API
 |
Cry::GamePlatform::IService
::GetBuildId
 |

Flow Graph Nodes
 |
GamePlatform:General:BuildId
 |
...
Flow Graph Nodes
 |
GamePlatform:General:GetEnvironmentVariable
 |
...
API
 |
Cry::GamePlatform::IPlugin
::GetService
 |

Flow Graph Nodes
 |
GamePlatform:General:GetService
 |
...
Flow Graph Nodes
 |
GamePlatform:General:MarkContentCorrupt
 |
...
Flow Graph Nodes
 |
GamePlatform:General:OwnsApplication
 |
...
Flow Graph Nodes
 |
GamePlatform:Listener:Service:OnEnvironmentVariableChanged
 |

Schematyc Nodes
 |
Signal::Receive::[EntityName]::Accounts::PlatformSignalReceiver::Service::OnEnvironmentVariableChanged
 |
...
Flow Graph Nodes
 |
GamePlatform:Listener:Service:OnOverlayActivated
 |

Schematyc Nodes
 |
Signal::Receive::[EntityName]::Accounts::PlatformSignalReceiver::Service::OnOverlayActivated
 |
...
Flow Graph Nodes
 |
GamePlatform:Listener:Service:OnShutdown
 |
