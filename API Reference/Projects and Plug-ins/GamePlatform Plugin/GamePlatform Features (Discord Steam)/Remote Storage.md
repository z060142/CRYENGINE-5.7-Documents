...
API
 |
Cry::GamePlatform::IRemoteStorage::IsEnabled
 |

Flow Graph Nodes
 |
GamePlatform:RemoteStorage:IsEnabled
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::IsEnabled
 |
...
API
 |
Cry::GamePlatform::IRemoteStorage::GetFile
 |
...
(handled via the file cache)
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::GetRemoteFileByName
 |
...
API
 |
Cry::GamePlatform::IRemoteStorage::GetSharedFile
 |
...
Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::GetSharedFileById
 |
...
API
 |
Cry::GamePlatform::IRemoteFileBase::IListener::OnDownloadedSharedFile
 |

Flow Graph Nodes
 |
GamePlatform:Listener:RemoteStorage:OnDownloadedSharedFile
 |

Schematyc Nodes
 |
Signal::Receive::[EntityName]::Accounts::PlatformSignalReceiver::RemoteStorage::OnDownloadedSharedFile
 |
...
Flow Graph Nodes
 |
GamePlatform:Listener:RemoteStorage:OnFileShared
 |

Schematyc Nodes
 |
Signal::Receive::[EntityName]::Accounts::PlatformSignalReceiver::RemoteStorage::OnFileShared
 |
...
API
 |
Cry::GamePlatform::IRemoteFile::Delete
 |

Flow Graph Nodes
 |
GamePlatform:RemoteStorage:DeleteRemoteFile
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::DeleteRemoteFile
 |
...
API
 |
Cry::GamePlatform::ISharedRemoteFile::Download
 |

Flow Graph Nodes
 |
GamePlatform:RemoteStorage:DownloadSharedFile
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::SharedFile::Download
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:FileExists
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::RemoteFile::Exists
 |
...
API
 |
Cry::GamePlatform::IRemoteStorageCache::VisitCache
 |

Flow Graph Nodes
 |
GamePlatform:RemoteStorage:GetCacheList
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:GetFileSize
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteFile::GetFileSize
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:GetSharedFileId
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::RemoteFile::GetSharedId
 |
...
API
 |
Cry::GamePlatform::ISharedRemoteFile
::
GetFileSize
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:GetSharedFileSize
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::SharedFile::GetFileSize
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ReadData
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::RemoteStorage::RemoteFile::ReadData
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ReadDataToFile
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::
RemoteStorage::RemoteFile
::ReadToFile
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ReadSharedData
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::
RemoteStorage::SharedFile
::Read
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ReadSharedDataToFile
 |
...
API
 |
Cry::GamePlatform::IRemoteStorageCache::ReleaseCache
 |

Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ReleaseRemoteFile
 |
...
API
 |
Cry::GamePlatform::IRemoteStorageCache::
ReleaseCache
 |

Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ReleaseSharedFile
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:ShareRemoteFile
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:WriteDataFromFile
 |
...
Flow Graph Nodes
 |
GamePlatform:RemoteStorage:WriteData
 |
...
API
 |
Cry::GamePlatform::IUserGeneratedContentManager::CreateDirect
 |

Flow Graph Nodes
 |
GamePlatform:UserGeneratedContent:CreateContent
 |
