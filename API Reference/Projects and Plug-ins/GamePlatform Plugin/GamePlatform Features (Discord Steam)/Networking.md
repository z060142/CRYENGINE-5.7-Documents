...
API
 |
Cry::GamePlatform::INetworking::CloseSession
 |

Flow Graph Nodes
 |
GamePlatform:Network:CloseSession
 |
...
Flow Graph Nodes
 |
GamePlatform:Network:FilterText
 |
...
Flow Graph Nodes
 |
GamePlatform:Network:AuthToken
 |
...
Flow Graph Nodes
 |
GamePlatform:Network:IsLoggedIn
 |
...
API
 |
Cry::GamePlatform::INetworking
::IsPacketAvailable
 |

Flow Graph Nodes
 |
GamePlatform:Network:IsPacketAvailable
 |
...
Flow Graph Nodes
 |
GamePlatform:Network:ReadPacket
 |
...
API
 |
Cry::GamePlatform::INetworking::SendPacket
 |

Flow Graph Nodes
 |
GamePlatform:Network:SendPacket
 |

Schematyc Nodes
 |
Function::GamePlatform::Service::Networking::SendPacket
 |
...
(callback provided to Cry::GamePlatform::IService::CanAccessMultiplayer)
 |
...
(uses provided callback to activate output directly)
 |
...
**
Signal::Receive::[EntityName]::Accounts::PlatformSignalReceiver::Networking::
OnCheckMultiplayerAccess
 |
...
Flow Graph Nodes
 |
GamePlatform:Listener:Networking:OnGetSteamAuthTicketResponse
 |
