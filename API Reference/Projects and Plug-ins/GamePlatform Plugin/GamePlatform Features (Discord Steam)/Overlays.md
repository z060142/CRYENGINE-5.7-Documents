...
API
 |
Cry::GamePlatform::IService::OpenBrowser
 |

Flow Graph Nodes
 |
GamePlatform:Overlay:OpenBrowser
 |
...
API
 |
Cry::GamePlatform::IService::OpenDialog
 |

Flow Graph Nodes
 |
GamePlatform:Overlay:OpenDialog
 |
...
API
 |
Cry::GamePlatform::IService::OpenDialogWithTargetUser
 |

Flow Graph Nodes
 |
GamePlatform:Overlay:OpenDialogWithTarget
 |
...
API
 |
Cry::GamePlatform::IService::OpenPurchaseOverlay
 |

Flow Graph Nodes
 |
GamePlatform:Overlay:OpenPurchaseOverlay
 |
