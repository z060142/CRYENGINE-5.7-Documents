...
Adds a lobby query filter that will be used on the next [QueryLobbies](Matchmaking%20%26%20Lobbies.md#Matchmaking%26Lobbies-querylobbies)call.
...
Returns the lobby at the specified index from the [QueryLobbies](Matchmaking%20%26%20Lobbies.md#Matchmaking%26Lobbies-querylobbies)result (after the [OnLobbyQueryComplete](Matchmaking%20%26%20Lobbies.md#Matchmaking%26Lobbies-lobbyquerycomplet)event).
...
Listen for the [OnLobbyQueryComplete](Matchmaking%20%26%20Lobbies.md#Matchmaking%26Lobbies-lobbyquerycomplete)event after querying the backend.
...
[Matchmaking Service Functions](#matchmaking-service-functions)[Matchmaking Service Events](#matchmaking-service-events)[Lobby Functions](#lobby-functions)[Lobby Events](#lobby-events)[Event Registration Functions](#event-registration-functions)
