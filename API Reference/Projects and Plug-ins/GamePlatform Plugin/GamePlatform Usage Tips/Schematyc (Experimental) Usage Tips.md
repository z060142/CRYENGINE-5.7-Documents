...
The data types listed listed in the GamePlatform category share common functions between them, such as
`
IsEqual
`
,
...
ToString
`
 function used on a data type from a specific platform is matched with a
`
FromString
`
