...
The client connection events are primarily only sent to the server, and identify each player by channel identifiers. For more information, see [Networking](Networking.md#Networking-Channels).
