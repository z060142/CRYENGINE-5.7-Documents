...
Access to the internal proximity grid is made possible by adding an instance of the [IEntityTriggerComponent](/docs/static/engines/cryengine-5/categories/28704770/pages/29797287) component to an entity, see the example below.
...
[API Types](#api-types)[Conclusion](#conclusion)
