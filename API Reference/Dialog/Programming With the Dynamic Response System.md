...
**Note: You should read the “**[DRS Concept](../../Manual/Editor%20Tools/Dynamic%20Response%20System/Dynamic%20Response%20System%20Concept.md)**"page first, to get a basic knowledge on DRS functionality.**
...
To check signals, go to the Responses tab in the DRS widget. In the **Recent** tab, you can find a list with all the signals that were recently sent. For more information about this widget, please see [Tutorial - Debugging Dynamic Response System Responses](../../Manual/Tutorials/Audio%20and%20Music/Tutorial%20-%20Setting%20Up%20the%20Dynamic%20Response%20System/Tutorial%20-%20Debugging%20Dynamic%20Response%20System%20Responses.md).
