...
ProfVis.exe,
`
 with this tool the data can be analyzed.

Simply drag and drop one of the files from
**
TestResult
**
 into the tool, or use the
**
File -> Open
**
...
Ctrl + Mouse Scroll
**
 to zoom in and out, and make sure to only use the horizontal scrollbar at the bottom to navigate left and right.
...
At the top-right there is a filter. Pressing
**
Enter
**
 will mask out anything that doesn't match the filter which makes it easier to find some markers.
...
**
 They both do the same (as explained before), but they allow a user to send an argument which will show up in the profiler as shown above (argument is a const char*).
