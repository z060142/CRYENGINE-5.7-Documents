...
During the play of a level, at runtime, necessary shaders will be requested with all the variables defined, such as lighting configuration and the usage of techniques like fog or transparency. If a shader is not found in the Shader Cache, it will have to be compiled locally or via a Remote Shader Compiler.
