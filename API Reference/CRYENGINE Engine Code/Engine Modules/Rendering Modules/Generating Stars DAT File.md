...
The header is immediately followed by entries for each star (the number of entries is stored in the header).
...
uint32
 |
Number of star entries in the file
 |
