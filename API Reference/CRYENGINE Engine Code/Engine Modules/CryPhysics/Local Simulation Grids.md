...
Since multi-grid support incurs some minor performance and memory footprint cost, it's currently turned off by default with a MULTI_GRID define (to enable it, CryPhysics has to be re-compiled).
