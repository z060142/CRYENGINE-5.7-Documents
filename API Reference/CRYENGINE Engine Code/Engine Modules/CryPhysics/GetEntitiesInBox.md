...
It's possible to query the physics system to get all the physical objects/entities contained into a specific box volume defined by a minimum and a maximum point using **GetEntitiesInBox** function
