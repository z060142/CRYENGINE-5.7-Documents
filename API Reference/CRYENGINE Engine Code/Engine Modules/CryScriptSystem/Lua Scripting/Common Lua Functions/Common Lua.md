...
**
 function within the Lua scripts as the last parameter.
...
pos
 ...
 |
3D vector world coordinates of the ray hit.
...
normal
 ...
 |
3D normal vector of the ray hit.
...
surface
 ...
 |
surface type identifier of the surface that was hit.
...
entity
 ...
 |
if an entity was hit, this contains the scripttable of the entity.
...
renderNode
 ...
 |
contains a scripthandle to a foliage or static render node.
...
g_SignalData
**
 table can contain the following parameter types:
...
ScriptHandle
 ...
 |
Normally used to pass along an entity identifier (
**
EnityId
**
).
...
Floating Point
 ...
 |
Possible floating point value you need to pass along.
...
Integer
 ...
 |
Possible integer or number value you need to pass along.
...
String
 ...
 |
Possible string value you need to pass along.
...
Logs the current system time to console. Formatting is like the following:
**
*
...
_tbl
 ...
 |
table to get the amount of key-value pairs from.
...
Creates a new table based on the given one in the parameter
**
_obj
**
...
_obj
 ...
 |
base table you want to create a new one from.
...
true
**
 it avoids recursive recreation of all sub-tables.
...
src
 ...
 |
source table to get the table information from.
...
recurse
 ...
 |
recursive merging of all sub-tables.
...
recursive
 ...
 |
recursive merging of all subtables
...
Used to convert a 3D vector table into a string and returns it as follows:
**
(x: X.XXX y: Y.YYY z: Z.ZZZ)
**
...
Used to log an error message to the console and the log file. The text color is set to
red
 in the console.
...
Used to log a warning message to the console and the log file. The text color is set to
yellow
 in the console.
...
`
LogWarning("MyWarning: %f", math.pi);
`
...
_class
 ...
 |
table you want to dump to console (e.g:
**
g_localActor
**
)
...
true
**
 it won't dump the table functions
...
depth
 ...
 |
defines the table tree depth you are interested in
...
str
 ...
 |
string to check if it is an empty string
...
Checks whether a number value is
**
true
**
 or
...
Checks if a subtable with a given name exists in the given table and returns it, otherwise it returns
**
nil
**
.
...
table
 ...
 |
base table to check for the subtable
