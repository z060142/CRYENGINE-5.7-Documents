...
Dumps all entity identifiers (
**
EntityId
**
), names, classes, positions and angles, which are currently used in the map, to console.
...
Compares two entities by their squared distance. If the distance to the point from entity one is greater than the distance to the point from entity two it returns
**
true
**
...
sender
 ...
 |
the entity which originally sent the event
...
event
 ...
 |
string based entity event to process
...
Adds usable functionality, like
**
OnUsed
**
 event, to a given entity table.
...
bPickable
**
 property to the entity properties table to add a basic pickable functionality to a given entity.
...
Adds spawn functionality to a given entity. Commonly used for
**
AI
**
 actors during the creation.
...
nSlot
 ...
 |
entity slot you want to physicalize
