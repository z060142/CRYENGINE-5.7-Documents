...
Finally, we want the guys to switch their behavior from idle to attack if they see an enemy. We'll then add the following line to the character (`Scripts/AI/Characters/Personalities/Cover.lua` in the example):
