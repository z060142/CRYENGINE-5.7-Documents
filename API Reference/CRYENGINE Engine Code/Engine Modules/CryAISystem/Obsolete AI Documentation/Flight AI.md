...
- Enables or disables the ability of the AI to position itself within the combat path to engage and shoot at its current target. By default an AI is *not* in combat mode until explicitly allowed to go into combat mode.
