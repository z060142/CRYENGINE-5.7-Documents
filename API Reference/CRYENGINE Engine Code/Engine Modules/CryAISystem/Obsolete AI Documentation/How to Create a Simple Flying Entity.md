...
Additionally, we will need to add the following line to the related section of `Code/Game/GameDll/GameFactory.cpp`:

```
REGISTER_FACTORY(pFramework, "Flyer", CFlyer, true /* is AI */);
```

It is necessary make the new entity appear in the list of AI entities in the Editor (**RollupBar -> Objects -> Entity -> AI -> Flyer**).
