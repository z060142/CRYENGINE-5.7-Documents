...
1. Add the [Walker.xml](/docs/static/attachments/23461252) file to the following folder:
...
2. Add the [WalkerIdle.lua](/docs/static/attachments/23461251) script to the following folder:
