...
This documentation is obsolete and applies to the pre-[MNM](/docs/static/engines/cryengine-3/categories/1114113/pages/1048672) navigation system AI used in CRYENGINE 3.3 and earlier.
...
The pathfinding algorithm uses a standard A* algorithm ([http://encyclopedia.thefreedictionary.com/A-star%20algorithm](http://encyclopedia.thefreedictionary.com/A-star%20algorithm)) implementation to generate the path. It works on top of the spatial representation described in the previous text.
