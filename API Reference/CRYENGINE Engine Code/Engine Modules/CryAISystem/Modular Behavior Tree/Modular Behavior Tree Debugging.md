...
Use the Slash-Key ("/") on the keyboard or the cvar "
`
...
The Slash-Key is just a shortcut for entering "
`
ai_DebugAgent centerview
`
...
The log files are plain text files that get written to the directory
`
.\user\mbt_logs
`
.

Each AI agent will store his execution history in a separate file that is named according to his entity name and entity ID (e. g. "
`
mbt_human1_3.txt
`
