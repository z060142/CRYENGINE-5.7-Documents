...
cluster detector
**
 is a new service offered by the AI System to detect clusters of point in space.
...
Currently it's used in connection with the
**
AISquadManager
**
 to group the different AI agents into dynamic squads.
