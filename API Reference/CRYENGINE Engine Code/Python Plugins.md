...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756813/pages/26217475
- Page ID: 26217475
- Breadcrumb: CRYENGINE Engine Code > Python Plugins
...
To create a basic python plugin, create a folder in **`<Editor Folder>/Editor/Python/plugins`** and create a file called "startup.py" there. On Sandbox startup those files are executed automatically.
