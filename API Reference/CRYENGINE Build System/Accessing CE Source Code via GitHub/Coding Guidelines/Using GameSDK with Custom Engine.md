...
This article covers a detailed walk through of the steps required to successfully compile and run the
**
...
-
Go to the newly downloaded GameSDK Sample Project folder and modify your project.cfg's
*
"engine_version=local"
*

-
Since we are building the GameSDK using the default WAF settings you will also need to modify project.cfg's
*
"sys_dll_game=CryGameSDK"
*

-
Run cry_waf.exe from the custom engine folder and create a
**
game_sdk
**
 project. Open the generated solution and compile
**
[GameSDK] Profile x64
**

-
Add the following Visual Studio project property to your
**
Debuging/Command Arguments
**

*
-projectroot "path_to_gamesdk_sample_downloaded_from_asset_database"
*
...
**
" to system.cfg
You can now run your game project using a custom engine from Visual Studio or the Game.bat file. To load a map type
**
"+map woodland"
**
