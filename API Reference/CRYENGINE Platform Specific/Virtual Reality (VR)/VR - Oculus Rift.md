...
Oculus Rift support is now included in CRYENGINE. This article covers the programming side of interacting with a Rift headset. For information on basic use, see [Oculus Rift](../../../Manual/Virtual%20Reality/Oculus%20Rift.md).

Chapters:

[Code](#code)[Check VR Setup](#check-vr-setup)[Get HMD Device Tracking State](#get-hmd-device-tracking-state)[Get Controller Tracking State](#get-controller-tracking-state)[React to Controller Input](#react-to-controller-input)[Oculus HRTF Plugin Support in Wwise](#oculus-hrtf-plugin-support-in-wwise)
...
- **InputListener:** Please read **[CryInput](../../CRYENGINE%20Engine%20Code/Engine%20Modules/CryInput.md).** Check for DeviceType ** eIDT_Motion**and KeyIds:
