...
[API Types](#api-types)[Components](#components)[Identifiers](#identifiers)[Transform & Parent / Child Hierarchy](#transform-and-parent-child-hierarchy)[Slots / Entity Geometry](#slots-entity-geometry)[Conclusion](#conclusion)
...
Entities are stored and managed in the **Entity System**, represented by the [IEntitySystem](/docs/static/engines/cryengine-5/categories/28704770/pages/29797278) interface, and accessible through * gEnv->pEntitySystem*. The system is responsible for spawning, managing entities throughout their lifetime, and finally removing them. See [IEntitySystem::SpawnEntity](/docs/static/engines/cryengine-5/categories/28704770/pages/29797278) for an example on how to spawn entities.
...
EntityIds are **not** unique across sessions or over the network. The same entity in a multiplayer match is very likely to have different identifiers on two clients. The multiplayer aspect of this applies to EntityGUIDs as well – please see Entity Networking to find out how entities can be identified over the network.
...
An entity can be linked to a parent at [spawn time](/docs/static/engines/cryengine-5/categories/28704770/pages/29797259), or at any point during an [during an instance's lifetime](/docs/static/engines/cryengine-5/categories/28704770/pages/29797019).
...
For more information, see [Slots, Geometry and Effects](Entity/Slots%2C%20Geometry%20and%20Effects.md).
