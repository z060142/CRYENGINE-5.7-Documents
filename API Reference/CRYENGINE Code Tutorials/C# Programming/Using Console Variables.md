...
*
ConsoleVariableInteger64Attribute
*
 |
*
...
*
ConsoleVariableStringAttribute
*
 |
*
...
A string console variable named
*
aStringProperty
*
 is declared and initialized. If the console variable changes value in native C++ code,
*
aStringProperty
*
 will also be modified and vice versa. Also note, that both
**
...
A
**
ConsoleCommandConfigurationException
**
 will be thrown if there are any misconfigurations.
...
ConsoleVariableString
**
 attribute (string type) is used with the wrong property
**
ConsoleVariableAttributeFloatProperty
**
 (floating point type).
