...
[Game Objects Pool](#game-objects-pool)[OnUpdate](#onupdate)[FrameTime](#frametime)[Game Status](#game-status)[Update Player](#update-player)[Update Other Game Objects](#update-other-game-objects)[Spawn Enemy](#spawn-enemy)
Related Content:
...
For more information on key-input evaluation, refer to the [Input and Game Controller](/docs/static/engines/cryengine-5/categories/23756813/pages/24283111) article.
