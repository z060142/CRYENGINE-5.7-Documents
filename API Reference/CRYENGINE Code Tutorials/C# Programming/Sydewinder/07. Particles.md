...
The easiest way to create a new particle effect is through the CRYENGINE Sandbox. For more information on the Particle Editor in CRYENGINE please refer to the [Particle System](/docs/static/engines/cryengine-5/categories/23756816/pages/24284330) chapter. The Sydewinder template consists of a few particle effects that have been created using the Sandbox. These include weapon trails, engine trails and explosion effects in the canyon level.

*An example of particle effects in Sydewinder.*![Image](https://www.cryengine.com/docs/static/attachments/26954566)

Chapters:

[Loading a Particle Effect](#loading-a-particle-effect)[Particle Emitters](#particle-emitters)
Related Content:
