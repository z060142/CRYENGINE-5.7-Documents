...
[Key States](#key-states)[Controlling the Player](#controlling-the-player)
Related Content:
...
The movement values are stored in the **`Speed`** variable and are applied to the **` PhysicsEntity`** by setting the **` Velocity`** in the **` Move`** method of the **` DestroyableBase`** class. For further information about physics processing see the chapter **[Physics Interaction](06.%20Physics%20Interaction.md)**.
