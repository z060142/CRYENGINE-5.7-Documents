...
Console Commands are validated with the ConsoleCommandAttributeManager. The validation of Console Command attributes will be activated if a "
*
**
DEBUG
**
*
" attribute is declared in the code. If nonstatic functions are applied with the ConsoleCommand attribute, a
**
ConsoleVariableConfigurationException
**
