...
[Initial Setup](#initial-setup)[Creating the Home UI](#creating-the-home-ui)[Adding Buttons](#adding-buttons)[Styling the Buttons](#styling-the-buttons)
...
For this part the CRYENGINE logo is required to be in the assets directory in **/assets/libs/ui**. The logo can be downloaded![Image](https://www.cryengine.com/docs/static/attachments/26956262).
...
The buttons will be displayed in a column. The **`UIButtonList`** is going to act as the container for the buttons in the menu. To make it easier to position the buttons the **` UIButtonList`** will inherit from **` VerticalLayoutGroup`** whichis specifically made to display elements in a column.
