...
[Initial Setup](#initial-setup)[Adding a Canvas and Text](#adding-a-canvas-and-text)[Adding an Image](#adding-an-image)[Adding a Button](#adding-a-button)[Final Code](#final-code)
...
Next up, an image will be added. First off, **right-click** and save**![Image](https://www.cryengine.com/docs/static/attachments/26956257)** into your '** Asset/libs/ui/**' folder. Due to the transparency the image may appear as a blank image but when you import it into your project you can view the difference.
