...
Useful for doing remote debug sessions and trying to attach at the very beginning of the program execution.
This is very useful when you can't launch Sandbox through Visual Studio with the already attached debugger.
...
Use CVar:
**
sys_project="Path to Project"
**
5.2 and before:

-
Register your local build by running the bat file found in
**
//ce/xxx/Tools/RegisterLocalBuild.bat
**
...
To use this uncomment the registration macro in
**
...
With the release of Qt 5.6, the
 visual studio plugin is not available anymo
re. However, we have included the Visual Studio visualizers in the solution (qt5.natvis) so everybody should be able to visualize Qt classes properly in their debugger.
