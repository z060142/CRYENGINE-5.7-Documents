...
- Do not include Qt in places that don't need it, separate code using our [UI Programming Patterns](UI%20Programming%20Patterns.md).
...
- **Use ItemModels effectively:** [ItemModels and ItemViews](ItemModels%20and%20ItemViews.md).
...
QIcon | CryIcon | Unified styling, icon color tinting etc. See [Theme, Styling, and Colors](../Sandbox%20Framework/Theme%2C%20Styling%20and%20Colors.md) Once constructed a CryIcon may safely be stored in a QIcon variable, so this is fine: QIcon foo = CryIcon("bar");
...
QPalette | QSS Stylesheet | QPalette is deprecated as we use style sheets. See [Theme, Styling, and Colors](../Sandbox%20Framework/Theme%2C%20Styling%20and%20Colors.md)
...
Another set of extensions to Qt is the [ItemModel Framework which is described in a dedicated page](ItemModels%20and%20ItemViews.md).
...
[Guidelines](#guidelines)[Reusable classes](#reusable-classes)[Must Use](#must-use)[Recommended use](#recommended-use)[Other reusable UI components](#other-reusable-ui-components)
