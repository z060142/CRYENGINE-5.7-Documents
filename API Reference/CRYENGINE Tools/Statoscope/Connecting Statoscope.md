...
"
*
 will get you frame length, graphics stats and user markers. Default datagroups: "
**
fgmtuO
**
"
...
-
1 for socket logging and choose
*
File -> Connect
*
 in the tool
...
-
0 for file logging and drag the file from “
*
statoscope/perflog.bin”
*
 file into the tool
...
**
The session file is stored in the location:
**
BuildRoot/statoscope/*.bin
**
...
The
session
file is stored in the location:
**
BuildRoot/user/statoscope/*.bin
**
...
-
Connecting to a running game with
*
File -> Connect
*
...
File -> Connect
*
 you can connect to a running version of the game whose e_StatoscopeLogDestination is set to 1.
...
Log to file
*
 is enabled you will be given the option of saving the log to disk for opening later.
