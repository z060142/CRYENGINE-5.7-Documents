...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756813/pages/23306658
- Page ID: 23306658
- Breadcrumb: CRYENGINE Tools > MemReplay > Getting Started with MemReplay
- Parent: MemReplay
...
-memreplay
**
 in your arguments list.

MemReplay is now tracking every allocation/free call and streams it into a
**
memlog-date-time.zmrl
**
 file. See table below for file location (depending on platform type):
...
MemReplay can be stopped manually by calling the console command
**
memReplayStop
**
. This will flush the remaining information to the disc.

Do not use the console command
**
memReplayResume
**
