...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/47316993/pages/56657995
- Page ID: 56657995
- Breadcrumb: Engine Release Notes (Current) > CRYENGINE 5 > CRYENGINE 5.7
- Parent: CRYENGINE 5

## Child Pages

- [Third Party SDKs in 5.7](CRYENGINE%205.7/Third%20Party%20SDKs%20in%205.7.md)
- [CRYENGINE 5.7.1](CRYENGINE%205.7/CRYENGINE%205.7.1.md)
...
[5.7 Overview](#57-overview)[Highlights](#highlights)[Release Notes](#release-notes)[Network](#network)[Sandbox](#sandbox)[Tools](#tools)[Plugins and Projects](#plugins-and-projects)[Mobile & Consoles](#mobile-and-consoles)
...
New documentation for the GamePlatform Plugin can be found [here](../../../API%20Reference/Projects%20and%20Plug-ins/GamePlatform%20Plugin.md).
