...
- Go to [https://github.com/CRYTEK/CRYENGINE/releases/5.5.0_preview2](https://github.com/CRYTEK/CRYENGINE/releases/5.5.0_preview2)
...
- **Visual Studio 2017 (15.7):**Sandbox will crash due to an exception. Occurs when building Sandbox using Visual Studio 15.7, then running the built Sandbox.
**Workarounds:**
