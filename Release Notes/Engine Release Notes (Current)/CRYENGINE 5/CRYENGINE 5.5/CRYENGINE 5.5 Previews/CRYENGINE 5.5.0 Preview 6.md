...
- Go to: [https://github.com/CRYTEK/CRYENGINE/releases/5.5.0_preview6](https://github.com/CRYTEK/CRYENGINE/releases/5.5.0_preview6)
...
- **ENTITIES:** Light Projector does not cast any shadows.
- **ENTITIES:** Using an entity/component as movement, rotation pivot/joint in Trackview does not play the animation in-game and or in pure game.
