...
uncrustify
*
 with Visual Studio it is possible to have your code auto-formatted in accordance with the guidelines and every time you save your work. This takes away any effort involved in complying with the standard.

##
Step 1: Preparation

You can find the tool at root
`
/Code/Tools/uncrustify
`
.

Get
 and store it at in a temporary location. Open it and change the
*
executable
*
 and
...
parameters
*
 paths so that they match your CRYENGINE installation directory (4 spots in total).
...
Import...
**
 button and load your customized
**
...
Verify that the application path and arguments path are valid, then
**
Save.
**
