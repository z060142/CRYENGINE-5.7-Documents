...
Although CRYENGINE 5.0 development focused on new features, it also refined some existing features to ease client interaction with CRYENGINE. Examples of which are the data driven thread manager; unifying all existing thread managers and changes to the way windows.h is included as well as a cleanup of outdated defines. For a full list of changes please see: [Important data and code changes (CRYENGINE 5.0)](../../CRYENGINE%205.0/Important%20CRYENGINE%20V%20Data%20and%20Code%20Changes.md)

CRYENGINE 5.1:

CRYENGINE 5.1 development focused on stability and standardizing engine source code formatting.

#### Highlights:

- Automatic code style rules; introduced in CRYENGINE 5.0, have been finalized.
- See [Upgrading to CRYENGINE 5.1 - Code Formatting](Upgrading%20to%20CRYENGINE%205.1%20-%20Code%20Formatting.md) if you have made changes to CRYENGINE source code, to ease integration.
...
**Note:** If you used file names similar to the ones in CryCommon in your project, the converter might falsely identify such a file and replace it with a path to the CryCommon file. The converted first tries to find a file in the local folder though.
...
Current (flat hierarchy) [On Disk] |  | Re-organised (sorted by module) [On Disk] | Re-organised (sorted by module) [Visual Studio]
--- | --- | --- | ---
![Image](https://www.cryengine.com/docs/static/attachments/44962620) | **=>** | ![Image](https://www.cryengine.com/docs/static/attachments/44962619) | ![Image](https://www.cryengine.com/docs/static/attachments/44962618)
