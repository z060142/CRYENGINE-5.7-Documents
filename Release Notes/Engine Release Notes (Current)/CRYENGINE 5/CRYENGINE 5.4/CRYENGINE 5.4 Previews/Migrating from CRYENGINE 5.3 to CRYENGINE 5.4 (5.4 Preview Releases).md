...
This is done by automatically detecting
**
.cpp
**
 and
...
.h
**
 files inside the Code directory, and adding them to the solution. This means that any customizations you have made in CMakeLists.txt will be removed upon generating solution, because of this we
**
strongly recommend
**
 backing up this file before upgrading.
...
-
Open the CRYENGINE 5.4 installation directory and navigate to
*
...
Right-click
**
in the installation folder to select
**
...
*
 in the command line window or "
*
.\cryselect.exe install
*
" in PowerShell, and then press
**
Enter
**
.
...
-
Now, open the 5.3 project's directory and right-click the
*
*.cryproject
*
 file to select
...
-
In the pop-up window, press the Browse (…) button, and navigate to the CRYENGINE 5.4 installation directory and then press
**
OK
**
(If the engine is already registered, the engine can be selected from the dropdown menu instead, and this step can be skipped).
...
C++
**
 project, CMake will build the solution in
*
Solutions/Game.win_x64
*
 directory. If it's a
**
C#
**
 project, the solution will be generated in the code folder. The solution will be named
**
*
Game.sln
*
...
-
Now, build the solution by pressing
**
...
CryGUID
`
 is fairly straightforward providing you know the hexadecimal representation and can be done as follows:
