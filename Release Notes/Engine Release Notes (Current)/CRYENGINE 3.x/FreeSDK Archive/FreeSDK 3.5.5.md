...
Please note that it is no longer possible to create levels larger than 4 x 4km (16km²). This only effects level creation though and support for existing larger heightmaps remains.

New features and official support for larger levels will be coming in the future through a new system called "Segmented Worlds" which we'll be talking about more in the future.
...
-
Flowgraph
 - Debugger step through port activations with F6 - Debug menu to disable flowgraph and flowgraph type debugging.
