...
- Select & delete all of the existing *.dds files inside your build (`<root>\GameSDK`).
...
As with every update, make sure to use the correct matching RC version for the build, and remember to update your [plugins](/docs) and use the [Settings Manager](/docs/static/engines/cryengine-3/categories/1114113/pages/12124943) to point CRYENGINE to the correct build.
