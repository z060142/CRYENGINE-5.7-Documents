...
In order to play a map in [Game Executable Launcher](Game%20Executable%20Launcher.md) using the game launcher application, the level needs to be prepared by generating and exporting some data.
