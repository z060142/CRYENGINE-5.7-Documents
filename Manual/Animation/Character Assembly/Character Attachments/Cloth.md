...
[Chapters:](#chapters)[Best Practices](#best-practices)[Usage](#usage)[Time-stepping](#time-stepping)

- ***Is cloth simulation really needed in every case?***Often, when we think of cloth, it is a stiff piece of textile and moves directly according to the characters body movement, e.g., a T-Shirt. Normally, these kinds of cloth don't need a full cloth simulation, since plausible movement can be achieved by skinning.
...
- Bend forces decreasewrinkles and folds and give the cloth a certain stiffness
