...
Used to enable the flight AI to fire at a target when used in combination with the
**
EnableCombatMode
**
...
Boolean
 |
How many times to loop around the path
 |
...
Any
 |
Triggers when flight AI is at the end of the path
 |
...
Any
 |
Triggers when flight AI is near the end of the path
 |
...
Any
 |
Triggers when flight AI has stopped
 |
