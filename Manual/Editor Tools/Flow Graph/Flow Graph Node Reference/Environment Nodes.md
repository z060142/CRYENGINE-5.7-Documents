...
String
 |
Material to be set for the ocean
 |
...
Float
 |
If stretching is performed or not
 |
...
Any
 |
Get the current environment wind vector
 |
...
Vec3
 |
Outputs current environment wind vector
 |
