...
This node is used to force the AI movement along a [path](../../../AI%20and%20Navigation/AI%20Overview/AI%20(NPC)/AI%20Control%20Objects.md) created by level designer.
...
[Animation](#animation)[ApproachAndEnterVehicle](#approachandentervehicle)[Bookmark](#bookmark)[End](#end)[HoldFormation](#holdformation)[JoinFormation](#joinformation)[Move](#move)[MoveAlongPath](#movealongpath)[Shoot](#shoot)[Stance](#stance)[Start](#start)[VehicleRotateTurret](#vehiclerotateturret)[Wait](#wait)
