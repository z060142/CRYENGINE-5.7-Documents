...
Any
 |
Triggered automatically by the material effect
 |
...
Any
 |
Triggered when the material effect has started
 |
...
Float
 |
Outputs the distance to the player
 |
...
Float
 |
Dynamic value set by game code
 |
