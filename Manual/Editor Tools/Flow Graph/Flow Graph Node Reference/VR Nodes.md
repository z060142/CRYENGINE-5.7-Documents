...
This node provides information about the connected Oculus Touch VR controllers.![Image](https://www.cryengine.com/docs/static/attachments/29688052)
...
In the above example, it is configured to respond to an input from the control mapping of **xi_a** (xbox controller ** A** / ** green** button). (See input devices info [HERE](/docs/static/engines/cryengine-3/categories/1638401/pages/1605639))
...
[ControllerTracking](#controllertracking)[OculusController](#oculuscontroller)[OpenVRController](#openvrcontroller)[QuadRenderLayer](#quadrenderlayer)[VR:TransformInfo](#vrtransforminfo)[VR:Tools](#vrtools)
