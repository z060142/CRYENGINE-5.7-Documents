...
Port | Type | Description
--- | --- | ---
**Paused** | Boolean | Pauses the time output when set to true. Default value: 0 Valid values: 0=false|1=true
...
[Delay](#delay)[FrameDelay](#framedelay)[MeasureTime](#measuretime)[RandomDelay](#randomdelay)[RealTime](#realtime)[ServerTime](#servertime)[Time](#time)[TimeOfDay](#timeofday)[TimeOfDayLoadDefinitionFile](#timeofdayloaddefinitionfile)[TimeOfDayTransitionTrigger](#timeofdaytransitiontrigger)[TimeOfDayTrigger](#timeofdaytrigger)[TimedCounter](#timedcounter)[Timer](#timer)
