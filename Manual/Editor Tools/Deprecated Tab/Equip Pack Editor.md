...
You can then add equipment from the
**
Available Equipment
**
 list into the
...
To assign a specific Equipment pack to an AI, simply reference the Equipment Pack name in the
**
EquipmentPack
**
 field of the AI Properties.
...
You can also access the Equipment Pack editor by clicking the EquipmentPack "
**
...
**
...
In the following picture we have a setup where on the completion or failure of
**
MissionObjective
**
...
Then once the next level has been loaded, we will restore the saved inventory, fade in and then activate the mission
**
MissionObjective2
**
.
