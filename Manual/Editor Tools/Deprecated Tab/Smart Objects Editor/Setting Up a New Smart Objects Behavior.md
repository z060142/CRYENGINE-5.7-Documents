...
- If the `Libs\ActionGraphs` sub-folder does not exit, then you will have to create it.
...
- **Central**: Create the rule on time in the Smart Objects editor and it will be available in every level in the whole game.
...
![Image](https://www.cryengine.com/docs/static/attachments/28900489) *The worker, the crate to be carried, and a pallet as a destination*
...
![Image](https://www.cryengine.com/docs/static/attachments/28900488) *Rule for bringing a crate to a delivery place*
...
[Creating a New Smart Objects Rule From Scratch](#creating-a-new-smart-objects-rule-from-scratch)[Getting Started](#getting-started)[More Complex Examples](#more-complex-examples)[Combining Smart Objects with Static Flow Graphs](#combining-smart-objects-with-static-flow-graphs)[Debugging Smart Objects](#debugging-smart-objects)
