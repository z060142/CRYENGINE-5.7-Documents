...
**YawSpeed/PitchSpeed** ** YawLimits/PitchLimits** | Rotation speed and limits (in degrees) for this part. To be able to rotate, either yawSpeed or pitchSpeed must be greater than 0. Arcs are displayed when limits are different from zero.
...
- *name*: can be freely chosen to identify the component.
...
[Editing a Vehicle](#editing-a-vehicle)[Creating a New Vehicle](#creating-a-new-vehicle)[Components of the Vehicle Editor](#components-of-the-vehicle-editor)[Editing Effects](#editing-effects)
