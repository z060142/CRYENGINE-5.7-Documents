...
It also allows you to copy existing materials and use them as a starting point for your specific material needs. Materials files (
**
.mtl
**
) are ideally located in the same folder as the object they were created for. However, as they can be freely assigned to any objects inside your game project, the only restriction is to place them inside the game project folder structure.
...
To open the legacy Material Editor, go to
**
...
![Image](https://www.cryengine.com/docs/static/attachments/44967610)
...
**
 ...
 |
Assigns a material to the object that is selected in the main Viewport; overwrites the original material (i.e. for a CGF) for this copy of the object in the editor.
...
**
 ...
 |
Resets the selected object's material to default (or the material stored in the *.cgf file).
...
**
 ...
 |
Selects the material which is assigned to the selected object.
...
**
 ...
 |
Interactively select a single Material or a sub-material of an object in the scene by using an eyedropper tool.

The Editor highlights an object's polygons sharing the same sub-material when the eyedropper tool is moved over them. Click
**
LMB
**
 to select the material/sub-material.

Also provides info about the name of the material/sub-material and the surface type ID in the Viewport.
...
**
 ...
 |
Select a filter to display materials in the library.

-
**
All materials
**
for example shows all materials that are in your working folder, no matter if they are checked in or not.

-
**
Used In level
**
 shows just the materials which are used in your level.
 |
...
**
 ...
 |
Saves the selected material (only works for materials outside of *.pak files)
...
CAUTION:
**
also deletes the *.mtl file. No Undo possible.
 |
...
**
 ...
 |
Opens a separate window which enables you to preview the material in more detail and from different angles.
...
**
 |
Cuts the selected material and moves it to the clipboard.
 |
...
**
 |
Copies the selected material onto the clipboard.
 |
...
**
 |
Opens File dialog and allows paste copied earlier material to specified folder.
 |
...
**
 |
Copies the name and the path of the material onto the clipboard.
 |
...
**
 |
Extracts the selected material from the *.pak file into a folder with the same path as in *.pak file.
 |
...
**
 |
Duplicates the selected material and puts the duplicate into the same folder.
 |
...
**
 |
Lets you rename the selected material.
 |
...
When deleting the material this way, it will be deleted from your hard-drive.
 |
...
**
 |
Resets the selected material to its default settings.
 |
...
**
 |
Assigns the material to the object you have selected in the Viewport.
 |
...
**
 |
Selects all objects the selected material has been assigned to.
 |
...
**
 |
Adds a new material in the active folder.
 |
...
**
 |
Adds a new Multi Material in the active folder.
 |
...
the *.pak file
 it's located in and ensure that read-only is not checked on the file properties.
...
**
 |
Uses a default object for a preview of the selected material.
 |
...
**
 |
Uses a plane for a preview of the selected material.
 |
...
**
 |
Uses a box for a preview of the selected material.
 |
...
**
 |
Uses a sphere for a preview of the selected material.
 |
...
**
 |
Uses a teapot for a preview of the selected material.
 |
...
**
 |
Changes the background of the preview to black.
 |
...
**
 |
Changes the background of the preview to gray.
 |
...
**
 |
Changes the background of the preview to white.
 |
...
**
 |
Changes the background of the preview to textured.
 |
...
**
 |
Enables back light for preview.
 |
...
Please see
[Tutorial - Getting Started with the Material Editor](../Tutorials/Game%20and%20Level%20Design/Materials%20Tutorials/Tutorial%20-%20Getting%20Started%20with%20the%20Material%20Editor.md)
**

**
to learn more about the basic of the Material Editor.
...
**
 |
Here you can select the shader you want to use. Generally you use illum/vegetation/glass shader. For more information on shaders, see
[Shader Reference](../Graphics%20%26%20Rendering/Shaders/Shaders%20in%20CRYENGINE/Shader%20Reference.md)
.
 |
...
![Image](https://www.cryengine.com/docs/static/attachments/44967582)
 |
![Image](https://www.cryengine.com/docs/static/attachments/44967581)
 |
![Image](https://www.cryengine.com/docs/static/attachments/44967580)
 |
...
![Image](https://www.cryengine.com/docs/static/attachments/44967579)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967578)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967607)
 |
![Image](https://www.cryengine.com/docs/static/attachments/44967606)
 |
![Image](https://www.cryengine.com/docs/static/attachments/44967605)
 |
...
![Image](https://www.cryengine.com/docs/static/attachments/44967577)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967576)

![Image](https://www.cryengine.com/docs/static/attachments/44967575)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967574)

![Image](https://www.cryengine.com/docs/static/attachments/44967573)

![Image](https://www.cryengine.com/docs/static/attachments/44967572)

![Image](https://www.cryengine.com/docs/static/attachments/44967571)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967597)
...
...
**
" button on the right side or copy and paste the texture path into an empty slot.
...
![Image](https://www.cryengine.com/docs/static/attachments/44967570)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967569)

 |
Opens the current texture's associated *.psd file in Photoshop (requires defining Texture Editor in
**
Preferences
**
).
...
![Image](https://www.cryengine.com/docs/static/attachments/44967568)

 |
Opens the current texture's *.tif file (if available) in Photoshop (requires defining Texture Editor in
**
Preferences
**
).
...
RGBA
 |
Special version of Normal maps. Additionally uses monochrome Alpha Channel (aka Gloss Map) to describe the Surface's Smoothness inside the Physical Based Rendering System.
 |

Specular (Reflectance map)
 |
_spec
 |
...
RGBA
 |
A decal that houses an alpha for laying over grime or moss on objects.
 |
...
RGBA
 |
The custom slot is generally used to expose common parameters such as SSS or opacity for opaque materials.
 |
...
![Image](https://www.cryengine.com/docs/static/attachments/44971442)
 |
![Image](https://www.cryengine.com/docs/static/attachments/44971444)
 |
![Image](https://www.cryengine.com/docs/static/attachments/44971443)
 |
...
![Image](https://www.cryengine.com/docs/static/attachments/44967567)
...
*
![Image](https://www.cryengine.com/docs/static/attachments/44967566)
*
 |
...
![Image](https://www.cryengine.com/docs/static/attachments/44967565)
...
![Image](https://www.cryengine.com/docs/static/attachments/44967564)
...
![Image](https://www.cryengine.com/docs/static/attachments/44971436)
...
**
![Image](https://www.cryengine.com/docs/static/attachments/44971437)
**
...
**
![Image](https://www.cryengine.com/docs/static/attachments/44971438)
**
...
Stretch Moving -
**
Similar to pen moving, but different in that the texture is stretched and not shifted to the adjusted direction until the maximum amplitude is reached and back until the minimum amplitude is reached:

**
![Image](https://www.cryengine.com/docs/static/attachments/44971439)
**
...
![Image](https://www.cryengine.com/docs/static/attachments/44971440)
...
Vertex Deformation
**
 function offers the opportunity to influence geometry.
...
-
Pressing the Add New Item button on the
[toolbar](Material%20Editor%20Legacy.md#MaterialEditorLegacy-Toolbar)
 while selecting the desired folder in the Browser;
...
If you don't know the name of the material but do know an object that the material is assigned to, select the object, go to the Material Editor and click the
**
Get Properties from Selection
**
 button.

Alternatively, you can start in the Material Editor by clicking the
**
Pick Material from Object
**
 button and then clicking on the object in the viewport.

-
Right click anywhere in the
[Parameters](Material%20Editor%20Legacy.md#MaterialEditorLegacy-Parameters)
 panel;
