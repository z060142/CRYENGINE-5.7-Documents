...
Color Modifiers are special Modifiers that can be found and, are only available, on the
**
Field: Color
**
feature.
...
**
 ...
 |
Defines a name for the attribute. If the attribute does not exist in this emitter, modifiers will be white.
...
**
 ...
 |
Allows the attribute color to be scaled and biased based on the values in these properties.
...
**
 ...
 |
Adjusts the levels of the attribute. Specifies how bright the mid grey colors should be, but without changing white or black levels.
...
**
 ...
 |
Enables the attribute color to be applied on new born particles.
...
This modifier is an equivalent to the
**
 Random
**
modifier,
...
**
 ...
 |
Specifies the amount of luminance (brightness) variation to be added to the particle.
...
**
 ...
 |
Specifies the amount of color saturation variance to be added to the particle. With a value of 0 all particles will look white, with a value of 1 all particles will have a fully saturated random color.
...
**
 ...
 |
Inherits the parent color when a particle is born.
...
Currently, there is limited support for the color modifiers on the GPU. The only color value that can be modified on the GPU is the color value of
**
Field: Color
**
. Color Curve can only be used when and only if the
**
Self
**
