...
**
 ...
 |
Click on the browse button or right click on the field and choose
**
Pick Resource...
**
 to select an RTPC from the Audio Controls panel.
...
**
 ...
 |
Specifies the Audio Trigger to execute when the particle dies. This trigger is optional. If is left blank the
**
Stop on Death
**
 option appears.
...
**
 ...
 |
Allows selecting the type of Occlusion Raycast options. CRYENGINE's Audio engine supports occlusion of audio sources by the scene geometry.

The following options are available under this property:
...
**
 ...
 |
Causes the audio object that has been assigned to
**
Play Trigger
**
 to follow the particle while it moves around the scene. It is recommended to use this setting if an audio event is in a looping mode.
...
**
 |
When the particle is killed, stops the execution of the audio item that has been assigned to
**
Play Trigger
**
