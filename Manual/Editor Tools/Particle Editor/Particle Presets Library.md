...
**falling****_debris** | Geometry, with an offset, falling to the ground with collisions.
...
For more information on the Particle Editor's node references, please refer to [Particle Effect Features](Particle%20Effect%20Features.md).

[Particle Preset Options](#particle-preset-options)[Advanced Folder](#advanced-folder)[Default Folder](#default-folder)[Default Component](#default-component)
