...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/44967623
- Page ID: 44967623
- Breadcrumb: Editor Tools > Advanced Tab > C# Output
- Parent: Advanced Tab
...
The C# Output window pops up when there is a problem with a C# asset. For more information, see [this page](../Asset%20Browser.md#AssetBrowser-Menu).

![Image](https://www.cryengine.com/docs/static/attachments/44967625)

### Menu

The Menu can be accessed via the![Image](https://www.cryengine.com/docs/static/attachments/44967624) icon on the top-right corner of the tool. When clicked, it reveals the followingsub-menus:
...
[Menu](#menu)[Toolbars](#toolbars)[Help](#help)
