...
![Image](https://www.cryengine.com/docs/static/attachments/44959212) *UDR Visualizer Overview*

For an example of creating debugging routines and using the UDR Visualizer to visualize Render Primitives, please refer to the [technical documentation](../../../API%20Reference/AI/Universal%20Debug%20Recordings%20(UDR).md) of UDR.
...
![Image](https://www.cryengine.com/docs/static/attachments/44959718) *Render Primitives in the Viewport*
...
Clicking the![Image](https://www.cryengine.com/docs/static/attachments/44959292) menu brings up the **Help** option, which directs users to the UDR Visualizer's user documentation.
...
[1. File](#1-file)[2. UDR Tree Panel](#2-udr-tree-panel)[3. Log](#3-log)[4. Menu](#4-menu)[CVars and Console Commands](#cvars-and-console-commands)
