...
**
 |
Exports a Console log file to a specified folder.
...
**
 |
Opens a Search bar to search in the Console output window.
...
**
 |
Finds the previous occurrence of your search.
...
**
 |
Finds the next occurrence of your search.
...
Using the Console is very straightforward: you enter a command or CVar in the command line, hit
**
Enter
**
...
Enter
**
 or clicking the Console Command or CVar of your choice will select it and display it in the command line. All you then need to do is enter a value and hit
**
Enter
**
 again to execute it.

The second column displays the console variable name, where the first letter(s) before the underscore represent the module the command belongs to. For example:
**
r
**
 for render and
...
For a full list of Console Commands, you can go to
**
...
For a full list of Console Variables,
you can go to
**
...
**
 |
Shows the name of the Console Variable.
...
**
 |
Shows the value the CVar has in your level at the time of the search.

Double-clicking on this value will let you change it right away without having to go back to the Console itself. Hit Enter to confirm the change and the change will be implemented.
...
**
 |
Gives a description of what the CVar does, including all possible values.
