...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/44965562
- Page ID: 44965562
- Breadcrumb: Editor Tools > Advanced Tab > Python Scripts
- Parent: Advanced Tab
...
The Menu can be accessed via the![Image](https://www.cryengine.com/docs/static/attachments/44966470) icon on the top-right corner of the tool. When clicked, it reveals the followingsub-menus:
...
For more information on how to create Python plugins, please see **[this page](../../../API%20Reference/CRYENGINE%20Engine%20Code/Python%20Plugins.md)**.

[Python Scripts](#python-scripts)[Menu](#menu)[Creating Python Plugins](#creating-python-plugins)
