...
As an example, a cinematic demonstrating the destruction of a village could be designed to use different layers of assets before and after the event of destruction. By default the
**
Level
**
**
Explorer
**
 is displayed in the bottom-left panel of the Sandbox interface, but it can also be accessed via
**
...
**
 ...
 |
Creates a new layer in the Level Explorer.
...
**
 ...
 |
Creates a new folder in the Level Explorer.
...
**
 ...
 |
Brings up the system's File Explorer to locate a previously exported layer; layer files must carry a
**
.lyr
**
 extension and may be imported into multiple levels as required.
...
**
 ...
 |
Deletes the selected object(s)/layer(s)/folder(s).
...
**
 ...
 |
Allows users to search for objects within a level by using the Search Bar in the Level Explorer.
...
**
 |
Toggles the visibility of the object(s)/layer(s)/folder(s) currently selected in the Level Explorer.
 |
...
**
 |
Toggles the visibility of all object(s)/layer(s)/folder(s) in the Viewport, except the object/layer/folder currently selected in the Level Explorer.
 |
...
**
 |
Hides all folders/layers of objects in the Viewport.
 |
...
**
 |
Makes visible all folders/layers of objects in the Viewport.
 |

**
Toggle Child Object Visibility
**
 |
Toggles the visibility of all objects that belong to the currently selected layer.
 |
...
**
 |
Hides all objects that belong to the currently selected layer, in the Viewport.
 |

**
Unhide Child Objects
**
 |
Makes visible all objects that belong to the currently selected layer, in the Viewport.
 |
...
**
 |
Toggles the lock on all object(s)/layer(s)/folder(s), except the object/layer/folder currently selected in the Level Explorer.
 |
...
**
 |
Locks all folders/layers of objects that have been placed in the current level.
 |
...
**
 |
Unlocks all folders/layers of objects in the Viewport.
 |

**
Toggle Child Object Locking
**
 |
Locks/unlocks all objects that belong to the currently selected layer.
 |
...
**
 |
Locks all objects that belong to the currently selected layer.
 |

**
Unlock Child Objects
**
 |
Unlocks all objects that belong to the currently selected layer.
 |
...
**
 |
Opens the file explorer and locates the selected layer's
**
.lyr
**
 file in the project's directory of assets.
 |
...
**
 |
Copies the name of the selected layer/folder to the clipboard, so that it can pasted into another application.
 |
...
**
 |
Copies the file path of the selected layer/folder to the clipboard, so that it can be pasted into another application.
 |
...
An Active Layer is the primary layer within which all inserted objects are placed by default; any layer might be set as the Active layer by double-clicking it.
**
Show Active Layer Contents
**
...
**
 ...
 |
Lists the entire hierarchy of created folders, layers and the objects they contain.
...
**
 ...
 |
Collapses the hierarchy of created folders, layers and the objects they contain, so that only the top-most levels within this hierarchy are displayed.
...
**
 ...
 |
Previously created filters are listed under this sub-menu. When a filter is selected, only those objects/layers/folders that meet the search criteria defined by the filter are displayed in the Level Explorer.

Applied filters can be cleared either by clicking the selected filter again, or by clicking the
**
Clear Criteria
**
 option from the
...
is enabled, the positions of the toolbars change with respect to the size of the Level Explorer window.
 |
...
An Active Layer is the primary layer within which all inserted objects are placed by default; any layer might be set as the Active layer by double-clicking it, or by right-clicking it and selecting the
**
Set as Active Layer
**
...
**
 |
Opens the toolbar customization window allowing users to customize existing toolbars, and/or create new toolbars.
 |
...
**
 |
When disabled, the positions of toolbars and spacers can be changed by drag and drop.
 |
...
**
 |
Lists all default and custom toolbars created for the Level Explorer, allowing users to select which toolbar they'd like to hide or display. By default, the following two toolbars are available in the Level Explorer:
...
**
 |
When a layer is selected in the Level Explorer, this option sets that layer as the Active Layer. By default, all inserted objects are placed in the Active Layer.
 |

**
Lock Read-Only Layers
**
 |
...
**
 |
Reloads the scripts of all legacy (LUA) entities included within the selected layer.
 |
...
**
 |
Allows the selected layer to be exported and saved as an external
**
.lyr
**
 file.
...
**
 |
Allows the selected layer to be exported and saved as a
...
**
 |
When enabled, the selected layer and its contents will be loaded in the game. Choosing not to load a layer right away improves performance.
 |
...
**
 |
Turns on the physics of physicalized objects in the selected layer.
 |
...
**
 |
Allows users to specify which platforms (
**
PC
**
,
...
Xbox One
**
) the selected layer and its contents are to be displayed on.
...
**
 ...
 |
Displays colors assigned to objects, layers and folders within the Level Explorer's list.

Colors may be assigned to an item within the Level Explorer by right-clicking it, and selecting the
**
Color
**
...
**
 ...
 |
The names of all objects, layers and folders are displayed in the Level Explorer, when this option is enabled.
...
**
 ...
 |
This menu option is not available when
**
Show Layers
**
 is active.
Lists additional columns that can be added to the Level Explorer, to display information relevant to the objects included within a level. The following columns are available:
...
**
 ...
 |
Displays the name of the layer to which an object belongs.
...
**
 ...
 |
Provides a more specific description of an object's type, in addition to its
**
Object Type
**
 property.
...
Type
**
 field could also be a modifiable string, as in the case of creating prefabs, wherein this field would indicate the user defined name assigned to a prefab.
...
**
 ...
 |
Displays the file path of the default material used by an object, when applicable.
...
**
 ...
 |
Displays the file path of the user defined material assigned to an object in place of their default material, where applicable.
...
**
 ...
 |
Displays the file path of an object's Crytek Geometry Format (
**
.cgf
**
) file, that contains information about the object's 3D geometry.
...
**
 ...
 |
Indicates the number of times an object is used within the current level.
...
**
 ...
 |
Indicates the minimal spec setting of a listed object.

An object's Spec value defines the game detail setting (low/medium/high/custom spec) within and above which the object is rendered within a level.
...
**
 ...
 |
Identifies the AI Group associated with an AI character object included within a level.
...
**
 ...
 |
Indicates the name of the object to which the current Entity might be linked.

If the current Entity is linked to the bone of a character with a skeletal mesh, the
**
Linked to
**
...
**
 is enabled.
Lists additional columns that can be added to the Level Explorer to display information relevant to the layers in a level. These columns are:
...
**
 ...
 |
Indicates whether a layer of objects may be exported and saved as an external
**
.lyr
**
 file.

Right-clicking a layer and selecting the
**
More (Layer) → Exportable
**
 option from its context menu will enable it to be exported as a
**
.lyr
**
 file.
...
**
 ...
 |
Indicates whether a layer may be exported and saved as an external PAK file of
**
.pak
**
 extension.
...
**
 ...
 |
Indicates whether a layer will be loaded in-game; choosing not to load a layer and its objects right away will improve performance.

To prevent a layer from being loaded in-game, right-click the layer and disable the
**
 More (Layer) → Auto-Load
**
...
**
 ...
 |
Indicates whether the physics of physicalized objects in a layer have been enabled or not.

T
o enable the physics of physicalized objects within a layer, right-click the layer and select the
**
More (Layer) →
**
**
...
PC, PS4, Xbox One
**
) across which a layer and its objects are to be displayed in the game level.

These platforms are set by right-clicking a layer and ticking them in the
**
More (Layer) → Platforms
**
 menu.
...
Ctrl+F
**
 when working within the Level Explorer takes you to the Search Bar at its top, allowing you to quickly search for object/layer/folder. When working within another panel/tool that doesn't have a search bar however,
**
Ctrl+F
**
 opens a new Level Explorer window with a Search Bar. This window can also be configured in the same way as the default Level Explorer.
...
For instance, consider a level containing objects named
*
village_hut
*
,
...
*
 vil
*
 via the Search Bar will cause the Level Explorer to list only these objects.
...
Depending on the selected object property, these values may be as simple True/False that can be toggled via the check box situated to the left of the value, or as in the case of object properties like
**
Object Type
**
 or
...
**
 ...
 |
Edits the default/existing name of the selected object, layer, or folder.
...
**
 ...
 |
Deletes the selected object, layer or folder (and its contents) from the level.
...
**
 |
When a layer is selected in the Level Explorer, this option sets that layer as the Active Layer.
 |
...
**
 |
Unhides all folders/layers of objects in the Viewport.
 |
...
**
 |
Allows users to assign a preset or custom color to the contents of a layer or folder in the Level Explorer.
 |
...
**
 |
Opens the file explorer to locate the selected layer's
**
.lyr
**
 file on disk.
...
**
 |
Copies the name of the selected layer to the clipboard, so that it can be pasted into another application.
 |
...
**
 |
Copies the file path of the selected layer to the clipboard, so that it can be pasted into another application.
 |
...
**
 ...
 |
Retrieves the most recently modified version of the selected layer from the repository.
...
**
 ...
 |
Retrieves a layer file from the repository to be worked upon locally; once Checked Out, a layer will no longer be editable by other developers until local modifications have been Submitted or Reverted.
...
**
 ...
 |
Discards all changes made to a layer file and restores it to its last local version.
...
**
 ...
 |
Performs the above Revert operation upon a layer file only if its contents haven't been modified.
...
**
 ...
 |
Commits the selected locally modified layers to the repository.
...
**
 |
Expands all layers and folders in the Level Explorer, to reveal the objects they contain.
 |
...
**
 |
Collapses all expanded layers and folders in the Level Explorer.
 |
...
**
 |
Allows the selected Entity to be used as a container for your Flow Graph logic.
...
**
 |
Lists all Flow Graphs containers where the selected Entity is referenced.

Clicking a listed Flow Graph container opens the Flow Graph tool, with its Search Panel configured to list all locations where the selected Entity is used in graph logic.
...
**
 |
Lists all Lua Events that can be triggered on the selected Entity.
 |
...
**
 |
Updates the Lua code logic of the selected Entity.
 |
...
**
 |
Updates the Lua code logic of all Entities in the level.
 |
...
**
 ...
 |
Adds the selected object to an existing Group or Prefab.

To add an object to a Group/Prefab, select the object from the Level Explorer and the destination Group/Prefab from the Viewport.
...
**
 ...
 |
Removes the selected object from a created Group or Prefab.

If the Group or Prefab belongs to a hierarchy of nested Groups/Prefabs, the detached object is moved up a level within the hierarchy.
...
If the Group or Prefab belongs to a hierarchy of nested Groups/Prefabs, the detached object is moved
to the root of the hierarchy, i.e., the current layer.
...
**
 ...
 |
Eliminates the parent-child relationship or link that the selected object might be a part of.
...
**
 ...
 |
Deletes the object from the level.
...
Clear All
**
 changes made to the selected object.
...
**
 ...
 |
Converts a non-Entity type object into an Entity.
...
**
Track View Sequences
**
 |
Lists all Track View sequences where the selected Entity is used.

Clicking a listed Track View sequence opens the Track View tool to reveal the Entity's position within it.
...
**
 ...
 |
Locates the currently selected object within the Asset Browser.
...
**
 ...
 |
Allows the selected prefab to be swapped with a different one from the Asset Browser.

This option appears only when the selected object is a prefab.
...
**
 ...
 |
Selects all instances of the selected prefab(s) that have been included within a level, even if these are nested in other prefabs.
...
**
 ...
 |
Assigns a preset or custom color to an object's listing within the Level Explorer.

 |

 |

Levels and their comprising layer files are written to disk within the
**
Assets → Levels
**
...
Alt
**
 while clicking upon the lock icon of a layer or folder unlocks all the layers and objects it contains.
Objects can still be snapped to locked objects or to objects in locked layers/folders, by holding down
**
Ctrl
**
 +
