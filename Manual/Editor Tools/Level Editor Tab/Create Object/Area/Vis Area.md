...
**
 ...
 |
Specifies how high the Vis Area is.
...
**
 ...
 |
Specifies if shadows from the world outside the Vis Area can travel inside.
...
**
 ...
 |
Specifies how far the Vis Area is rendered.
...
**
 ...
 |
Lets users choose to see only the skybox when you look outside the Vis Area.

If the terrain and outside brushes are not rendered, the performance can be improved. Use this option when it is appropriate.
...
**
 ...
 |
Specifies if the ocean rendering should be visible inside the Vis Area.
