...
Area
**
 section. Now select the Audio Area Ambiance entity that has been placed near to the AreaSolid to attach the ambience sound entity to the Solid object as a target.

-
Try to modify the AreaSolid object with the Designer tool as explained above. If users want to visualize the sound to see how it works, they can type
**
s_DrawAudioDebug = abcdefvw
**
 in the console. When approaching an open space in the AreaSolid Object, users will be able to see the red ball as follows.
