...
Door entities are used to create different types of doors. The door entities can be found in
**
Create Object → Legacy Entities → Doors
**
.
...
The Advanced Door entity has additional properties that allows the door to
**
receive damage
**
 and be
...
destroyed
**
 appropriately. These are mostly controlled in the Breakage, Destruction and Vulnerability property tables.
...
The Anim Door entity is another door entity available in the engine, the advantage of this entity is that you can use
**
animations
**
 to control how the door opens and closes.

The Physics properties table also allows the Door to have physical properties though unlike the Advanced Door the Anim Door entity
**
cannot
**
 be
...
If you do not require the Door to interact physically with the world it is best to set the
**
Physicalize
**
,
...
RigidBody
**
 flags to false as this will save on performance.
