...
The Elevator and ElevatorSwitch entities can be found in the
**
Create Object →  Legacy Entities → Elevators
**
 folder.
...
**
 |
Specifies which sound file would be played while the elevator is moving.
 |

**
Sound Sound on Start
**
 |
Specifies which sound file would be played when the elevator starts moving.
 |
...
**
 |
Specifies which sound file would be played when the elevator stops moving.
 |
...
**
 |
Specifies the maximum distance from which the switch can be used.
 |
...
**
 |
Specifies a message to be shown when the player gets close to the switch.
 |
