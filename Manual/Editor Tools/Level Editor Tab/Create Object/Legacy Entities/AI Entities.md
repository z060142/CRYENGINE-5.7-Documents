...
The main Entity new users will want to use is the
**
...
**
 ...
 |
Defines the height, if used as a 3D Territory. 0 = infinite height (2D Territory).
...
**
 ...
 |
"Vision Cone" that AI will search for objects marked as interesting using the interest system.
...
**
 ...
 |
The minimum Object Interest level the AI will consider, any objects set with a interest level lower than this value will be ignored by the AI.
...
**
 ...
 |
This needs to be set for certain characters, so that they can react when player is looking at them. This represents the timeout before AI starts react on player looking.
...
Override
**
allowLookAimStrafing
**
 flag from base actor parameters (see Scripts\Entities\AI\Characters\Human_x.lua).

When
**
allowLookAimStrafing
**
 is enabled the actor’s body will turn slightly towards the look direction.
...
**
 ...
 |
Name to be used when this entity used as prototype for spawning.
...
**
 ...
 |
If Usable is True then the player can click Use button on this AI.
...
Deprecated -
**
 Text to be displayed on screen to show that Use button can be used there.
...
**
 ...
 |
Enable/disable death sound effect. Please note: a known issue causes death sounds to play regardless of the value of
**
PlayDeathSound
**
, but you can work around this by simply not setting
**
...
**
 ...
 |
Normal field of view (no peripheral vision) of this AI, in degrees. Negative value would mean unlimited FOV. Angular visibility multiplier fades from 1 (inside of
**
FOVPrimary
**
) to 0 (outside of
...
**
 ...
 |
How far this AI can see enemies. Targets out of sight range can not be seen; visibility of a target fades as a quadratic function.
...
sightrange
**
 but for targets of vehicle type.
...
This is tied and affected by the Rate of Death system. If an AI had an Accuracy of 0.5 it will double the base time (=AI_RODAliveTime) the player can survive under fire.
...
This is tied and affected by the Rate of Death system: combat zone distance = attackrange x AI_RODCombatRangeMod (CVar)
