...
**
 ...
 |
The color that distinguishes the entity on the Level Explorer panel.
...
**
 |
Clicking the Browse button next to this field will reveal a browser where you can select a material for the entity.
 |
...
**
 ...
 |
When set, the selected object only appears in game detail settings of the desired value and above.

(i.e. when set to medium spec, the object will not appear in low spec, but will appear in medium spec, high spec and above). The default minimal spec is Any.
...
**
 ...
 |
When set, this object will cast a shadow on the selected quality setting and above.
...
**
 ...
 |
Defines how far from the current camera position that the object will be rendered.
...
**
 ...
 |
When set, this object will not be shown in pure game mode. Useful for debugging or prototyping in Sandbox.
...
**
 ...
 |
Used to eliminate z-buffer artifacts when rendering in first person view.
...
**
 ...
 |
If this is set to true, decals will not be rendered on this object.
...
**
 ...
 |
This is mostly used on AI entities for memory optimization.
...
**
 ...
 |
If true entity can apply damage to other breakable objects.
...
**
 ...
 |
If true, players can trigger large object interactions (such as grab and kick) with the entity.
...
**
 ...
 |
If true the object will not spawn in a physically 'awake' state. Instead it will wait until being physically interacted with first.

This parameter would be used in the case where you have a floating object you wish to fall (or not) when entering the game.
...
**
 ...
 |
If true entity will load/save it’s state.
...
**
 ...
 |
Object does not receive damage, but will register "Hit" output when applicable.
...
>
**
' button will give you more options related to this file.
...
**
 ...
 |
Click the Reload Script to implement any changes made to the script. This is particularly useful for reviewing Particle Effects as reloading it activates it again.
...
**
 ...
 |
List Flow Graphs that the selected entity is associated with.
...
**
 ...
 |
If a Flow Graph was created on this entity, you can remove/delete that Flow Graph via this button.
...
**
 ...
 |
If the entity is being used in a Track View sequence the name of the sequence will be displayed here. Clicking on the button will also open up the sequence in the Track View Window.
...
**
 ...
 |
This saves the physical state of a selected entity (when AI/Physics in turned on).

This can be useful for placing physical props realistically around the world without having to manually rotate and align their positions.
...
Pick
**
button and then select the desired entity to create a link. You can select multiple entities one at a time while the button is still active.
...
**
 |
Links two objects, click an object that you would like to link with another object and click the Pick button and finally your desired object.

You will visually see the link in the perspective viewport and see the object name in the target window.
 |
...
**
 |
Removes a link between two objects, click the desired object in the Target window and click Remove.
 |
...
**
 |
Clicking the Edit Shape button turns on the shape editing mode and allows you to edit the selected shape.
 |
...
**
 |
The Reverse Path button is used with objects like AIPath and when clicked will reverse the AI path. The arrow on screen will point in the opposite direction to show the new path direction.
 |
...
**
 |
This button will flatten the shape and all other points to the height of the selected point.
 |
...
**
 |
Links a shape to an object, click a shape that you would like to link another object and click the Pick button and finally your desired object.
