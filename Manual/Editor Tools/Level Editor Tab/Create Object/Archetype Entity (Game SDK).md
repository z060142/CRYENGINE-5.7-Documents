...
**
Shadow Minimum Graphics
**

 |
When set, the object will cast a shadow based on the minimum graphics setting.
...
**
 |
Defines the GI mode that would be assigned to the entity.
 |
...
**
 ...
 |
When set, this object is not shown in the game mode.
...
**
 ...
 |
Used to eliminate z-buffer artifacts when rendering from first person view.
