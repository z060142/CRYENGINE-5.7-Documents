...
**
 ...
 |
Sets the distance between each point along the spline. Smaller values increase the polygon count of the surface but also smooths out corners.
...
**
 ...
 |
When enabled, follows the spline specified in the level.
...
**
 ...
 |
Set the brush to occlude rain, this works in conjunction with Rain Entity. If your level does contain rain, you should set this wisely, as there is a limit of 512 objects that can occlude at any given time.
...
**
 ...
 |
Normally, objects are considered to be in only one visarea. This option allows them to be added to multiple visareas if their bounding box overlaps them, at the cost of some performance. Without this option, some large objects may not be displayed when viewed through portals in certain situations.
...
**
 ...
 |
Sets the distance from the current view at which the object renders.
