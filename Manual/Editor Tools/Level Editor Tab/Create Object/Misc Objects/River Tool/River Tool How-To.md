...
Misc → River
**
. As with all of the tools in the Misc category, click to activate it.
...
With the river entity selected, go to the
**
Properties
**
 panel and click the button next to the
**
Material
**
 field.
...
When finished selecting the material and making any adjustments, press the
**
...
Edit
**
 mode from above if active, It is also possible to snap the individual points to the terrain the same way as with objects: by clicking
**
Ctrl + Shift + LMB
**
...
Default Width
**
 will allow you to type in a specific width for the river at that point you've selected.
