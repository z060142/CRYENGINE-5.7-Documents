...
This is partly overcome by working with multiple layers to which objects may be assigned in the [Level Explorer](../Level%20Explorer.md). Additionally, the Engine also allows for links or associations to be created between multiple objects such that any changes made to a single object automatically influences others with which it might be associated.
...
- Individually clicking upon them within the Viewport while holding the **Ctrl** key or;
- Dragging a selection box around multiple objects within the Viewport.

![Image](https://www.cryengine.com/docs/static/attachments/36840427) *Group Creation*
...
![Image](https://www.cryengine.com/docs/static/attachments/36840431) *Bounding Box*
...
![Image](https://www.cryengine.com/docs/static/attachments/36840432) *Ungroup/Open*
...
- Right-clicking the object and selecting the **Attach to...** option;
- Selecting the target group to which the selected object must be added.

![Image](https://www.cryengine.com/docs/static/attachments/36842025) *Attach to...*

Having trouble selecting the target group? Activate Helpers by clicking the![Image](https://www.cryengine.com/docs/static/attachments/36842673) icon at the top of the Viewport, hold the **Spacebar** to show pivot points, and click the pivot point of the Group.
...
- Opening the object's group using the **Open** button from the group's Properties panel;
- Selecting the desired object from the Viewport;
- Right-clicking the object and selecting the **Detach** option.

![Image](https://www.cryengine.com/docs/static/attachments/36842026) *Detach*
...
A selected group may be saved as an external OBJ file from the **Level -> Export Selected Object(s)** option of the Main Menu. Previously saved groups can then be imported into a level using the[Asset Browser](../../Asset%20Browser.md).
...
![Image](https://www.cryengine.com/docs/static/attachments/28274866) *Moving a child object*

*![Image](https://www.cryengine.com/docs/static/attachments/28274867) Moving a parent object*

Linking does not work on static Brush objects; only [Entity](../../../Entities%20and%20Tools.md) type objects can be linked.
...
- Select the desired child object, right-click it and click **Link To...**;
- Select the target parent object immediately after as shown.

![Image](https://www.cryengine.com/docs/static/attachments/36842751) *Linking and Unlinking*
...
- Select the desired entity, right-click it and click **Link To...**;
- Hold down the **Shift** button and select the target character by clicking upon it once in the Viewport; this displays a list of the character's bones in a pop-up menu.
...
Alternatively, objects can be linked and unlinked from the **Link -> Link/Unlink** options of the Main Menu or via the![Image](https://www.cryengine.com/docs/static/attachments/36840435) icons of the [Selection](../../../CRYENGINE%20-%20Getting%20Started/For%20New%20CRYENGINE%20Users/CRYENGINE%20V%20Interface/Toolbars.md#Toolbars-Selection) toolbar.

![Image](https://www.cryengine.com/docs/static/attachments/36840434) *Link -> Link/Unlink*

To Link two objects using either of the two methods:

- Select **Link -> Link** option from the Main Menu or the![Image](https://www.cryengine.com/docs/static/attachments/36842754) icon;
...
A link in progress is indicated by a red line whereas a blue line represents a completed link; clicking upon ![Image](https://www.cryengine.com/docs/static/attachments/36842752) at the top of the Viewport will exit Link mode. Similarly a child is unlinked from its parent by selecting it within the Viewport, and clicking upon either **Link -> Unlink** or the ![Image](https://www.cryengine.com/docs/static/attachments/36842755) icon.
...
![Image](https://www.cryengine.com/docs/static/attachments/36842412) *Level Explorer Grouping/Linking*

### Entity Links

A third kind of link that can exist between objects is an Entity Link.

An Entity Link merely represents a logical relationship that exists between [Entity](../../../../API%20Reference/Entity.md) type objects, and any change made to an entity within an Entity Link doesn't affect the other.

Such logical links between entities can be used to script sequences of events using [Flow Graph](../../Flow%20Graph.md) for example, where the [GetEntity](../../Flow%20Graph/Flow%20Graph%20Node%20Reference/Iterator%20Nodes.md)node retrieves created Entity Links.
...
- Select the first entity and scroll down to the **Entity Links** section in the Properties panel.
![Image](https://www.cryengine.com/docs/static/attachments/36840378)
*Entity Links section.*
- Click **Pick** and select the target Entity type object with which the currently selected entity needs to be linked.  A green line will indicate that the link process has been successfully completed.
![Image](https://www.cryengine.com/docs/static/attachments/36840377)
*Pick*
- Users may continue selecting multiple Entities to link the currently selected object with or edit the current link's properties from the Properties panel. Selecting the **Clear** option discards all created Entity links, while clicking![Image](https://www.cryengine.com/docs/static/attachments/36842756) exits the Entity Links mode.

Cannot see a green line between linked entities?

Make sure Display Object**s Link is** enabled in the Editor preferences at ** Edit->Preferences->Viewport->General.**![Image](https://www.cryengine.com/docs/static/attachments/36840376) * Display Objects Link*

##### Renaming

The **Name** field under the ** Links** section can be edited to provide Entity Links with a custom name.

![Image](https://www.cryengine.com/docs/static/attachments/36840375) *Renaming*

##### Replacing Targets

To replace the target entity of any given Entity Link, click the **Arrow** button![Image](https://www.cryengine.com/docs/static/attachments/36840380) next to the ** Target** field of the ** Entity Links** section before making a new selection.

### Run-time Links Using Flow Graph

Objects can be linked and unlinked during game run-time through [Flow Graph](../../Flow%20Graph.md) by making use of the[ChildAttach and ChildDetach](../../Flow%20Graph/Flow%20Graph%20Node%20Reference/Entity%20Nodes.md#EntityNodes-AttachDetach) Entity Nodes respectively.

[Grouping](#grouping)[Linking](#linking)[Entity Links](#entity-links)[Run-time Links Using Flow Graph](#run-time-links-using-flow-graph)
