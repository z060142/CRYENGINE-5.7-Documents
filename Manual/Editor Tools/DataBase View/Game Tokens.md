...
Game Tokens tab uses the default DataBase View toolbar set. For all the toolbar options and their functionalities, please refer to the [DataBase View](../DataBase%20View.md) page.
...
[Toolbar](#toolbar)[Creating Tokens](#creating-tokens)[Saving Tokens across Levels](#saving-tokens-across-levels)[Debugging](#debugging)
