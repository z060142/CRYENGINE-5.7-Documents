...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/29450447
- Page ID: 29450447
- Breadcrumb: Editor Tools > Designer Tool Tab > Modeling > Shapes
- Parent: Modeling
...
You can modify the the drawn box with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
--- | ---
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge.![Image](https://www.cryengine.com/docs/static/attachments/35395289)
**Width** | Width of the shape.
**Depth** | Depth of the shape.
**Height** | Height of the shape.
**Alignment to another polygon** | When still in drawing mode (when the object is transparent), aligns the top polygon with that of another shape you hover over with your mouse. Only works in the same Designer object; if you create a separate object holding **Shift** while drawing, you will not be able to align it to another object.![Image](https://www.cryengine.com/docs/static/attachments/35395312)
...
You can modify the the drawn sphere with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
Property | Description
--- | ---
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge. For an example, see [further up the page](Shapes.md#Shapes-EnableMagnet).
**Subdivision Count** | The number of polygons the radius of the sphere is divided into. The higher the Subdivision Count, the smoother the sphere will be.
**Radius** | The radius of the sphere; basically how big the sphere will be.
**90 Degrees Snap** | Makes the corner of the object closest to the cursor snap to the Y or X axis, causing the object to be at a 90-degree angle to that axis. Useful to make sure objects are orientated in the same direction. The profile will light up when the object has snapped to an axis this way.![Image](https://www.cryengine.com/docs/static/attachments/35395314)
...
You can modify the the drawn cylinder with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
--- | ---
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge. For an example, see [further up the page](Shapes.md#Shapes-EnableMagnet).
**Subdivision Count** | The number of polygons the radius of the sphere is divided into. The higher the Subdivision Count, the smoother the cylinder will be.
**Radius** | The radius of the cylinder.
**90 Degrees Snap** | Makes the corner of the object closest to the cursor snap to the Y or X axis, causing the object to be at a 90-degree angle to that axis. Useful to make sure objects are orientated in the same direction. The profile will light up when the object has snapped to an axis this way. For an example, see [further up the page](Shapes.md#Shapes-90snap).
**Height** | Height of the shape.
**Alignment to another polygon** | When still in drawing mode (when the object is transparent), aligns the top polygon with that of another shape you hover over with your mouse. Only works in the same Designer object; if you create a separate object holding Shift while drawing, you will not be able to align it to another object. For an example, see [further up the page](Shapes.md#Shapes-AlignToPolygon).
...
You can modify the the drawn cone with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
--- | ---
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge. For an example, see [further up the page](Shapes.md#Shapes-EnableMagnet).
**Subdivision Count** | The number of polygons the radius of the cone is divided into. The higher the Subdivision Count, the smoother the cone will be.
**Radius** | The radius of the cone; basically how big the sphere will be.
**90 Degrees Snap** | Makes the corner of the object closest to the cursor snap to the Y or X axis, causing the object to be at a 90-degree angle to that axis. Useful to make sure objects are orientated in the same direction. The profile will light up when the object has snapped to an axis this way. For an example, see [further up the page](Shapes.md#Shapes-90snap).
**Height** | Height of the shape.
**Alignment to another polygon** | When still in drawing mode (when the object is transparent), aligns the top polygon with that of another shape you hover over with your mouse. Only works in the same Designer object; if you create a separate object holding Shift while drawing, you will not be able to align it to another object. For an example, see [further up the page](Shapes.md#Shapes-AlignToPolygon).
...
![Image](https://www.cryengine.com/docs/static/attachments/28900522)![Image](https://www.cryengine.com/docs/static/attachments/28900521)
...
You can modify the the drawn rectangle with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
You can modify the the drawn disc with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
--- | ---
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge. For an example, see [further up the page](Shapes.md#Shapes-EnableMagnet).
**Subdivision Count** | The number of polygons the radius of the disc is divided into. The higher the Subdivision Count, the smoother the disc will be.
**Radius** | The radius of the disc.
**9o Degrees Snap** | Makes the corner of the object closest to the cursor snap to the Y or X axis, causing the object to be at a 90-degree angle to that axis. Useful to make sure objects are orientated in the same direction. The profile will light up when the object has snapped to an axis this way. For an example, see [further up the page](Shapes.md#Shapes-90snap).
...
You can modify the the drawn polyline shape with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
You can modify the the drawn curve with various other tools in the Designer tool (e.g. Extrude, Offset, Move tools etc., see [Selection](Selection.md)).
...
--- | ---
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge. For an example, see [further up the page](Shapes.md#Shapes-EnableMagnet).
**Subdivision Count** | The number of polygons the curve is divided into. The higher the Subdivision Count, the smoother the curve will be.
...
![Image](https://www.cryengine.com/docs/static/attachments/28900525)![Image](https://www.cryengine.com/docs/static/attachments/28900524)
...
**Mirror** | Mirrors the stairs against an invisible plane centered.
...
**Depth** | Depth of the stairs.
**Height** | Height of the stairs.
**Alignment to another polygon** | When still in drawing mode (when the object is transparent), aligns the top polygon with that of another shape you hover over with your mouse. Only works in the same Designer object; if you create a separate object holding Shift while drawing, you will not be able to align it to another object. For an example, see [further up the page](Shapes.md#Shapes-AlignToPolygon).
...
**Enable Magnet** | When enabled, the cursor will snap to vertices and edges on the shape, making it easier to align the shape you're drawing to the already existing shape. A small box will be displayed on the cursor, which will change color when it is snapped to a vertex or edge. For an example, see [further up the page](Shapes.md#Shapes-EnableMagnet).
**Step Rise** | The size of each step rise.
**Closed Profile** | Closes the profile (side) of the stairs when enabled. This will only be visible when the stair profile has been extruded to create a staircase. *Closed vs. Open Profile![Image](https://www.cryengine.com/docs/static/attachments/35395316)*
...
**Brush Size** | Select the cube brush size. This Brush size can be changed scrolling the mouse wheel and holding CTRL in the viewport.
**Merge Sides** | With this check box enabled, the added faces or remained faces after removing a cube will be merged with the adjoining faces.
...
![Image](https://www.cryengine.com/docs/static/attachments/28900511)![Image](https://www.cryengine.com/docs/static/attachments/28900510)
...
![Image](https://www.cryengine.com/docs/static/attachments/28900509)![Image](https://www.cryengine.com/docs/static/attachments/28900508)
...
[Box](#box)[Sphere](#sphere)[Cylinder](#cylinder)[Cone](#cone)[Rectangle](#rectangle)[Disc](#disc)[Polyline](#polyline)[Curve](#curve)[Stair](#stair)[Stair Profile](#stair-profile)[Cube Editor](#cube-editor)[Examples](#examples)
