...
[Sections](#sections)[The Request](#the-request)[First, Figure Out ScopeMask](#first-figure-out-scopemask)[Then, Install Fragments on the Scopes in the Scopemask](#then-install-fragments-on-the-scopes-in-the-scopemask)
