...
To finally expose your new DeferredEvaluator factory to the UQS core, you'd just call this static helper method once receiving the `UQS::Core::EHubEvent::RegisterYourFactoriesNow` event:
...
[Evaluation Modality and Cost Category](#evaluation-modality-and-cost-category)[Example DeferredEvaluator: TestRaycast](#example-deferredevaluator-testraycast)[Registering DeferredEvaluators](#registering-deferredevaluators)
