...
DoUpdate()
Notice the **DoUpdate()** method, which will be called through a base class's method by applying the **[https://en.wikipedia.org/wiki/Curiously_recurring_template_pattern](https://en.wikipedia.org/wiki/Curiously_recurring_template_pattern)**
...
[Example Generator: PointsOnPureGrid](#example-generator-pointsonpuregrid)[Registering Custom Generators](#registering-custom-generators)
