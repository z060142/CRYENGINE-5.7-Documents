...
The Universal Query System (UQS) is implemented as a CryPlugin. Please refer to the official Plugin System documentation for any further information (this is not part of the UQS documentation): [Plugin System](../../Beta%20Features/Plugin%20System.md)
...
[UQS CryPlugin](#uqs-cryplugin)[Startup and Update](#startup-and-update)
