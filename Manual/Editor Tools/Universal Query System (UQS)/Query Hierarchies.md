...
-
Chained query
A query is usually a combination of these, thus creating a
*
hierarchy
*
...
Chained
**
 queries are composite queries (i. e. are
*
branches
*
 in the tree), whereas
...
Regular
**
 queries do the actual grunt work of evaluating items (i. e. they are
*
leafs
*
 in the tree).
...
Using the analogy of a Behavior Tree, then this type of query would be an
**
Action
**
node in the tree.
...
Using the analogy of a Behavior Tree, then this type of query would be a
**
Selector
**
node in the tree.
