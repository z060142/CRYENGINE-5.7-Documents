...
std::TestRaycast
**
 evaluator: the underlying raycaster uses the Renderer to regulate the number of raycasts per frame and will therefore not work on a dedicated server! (Read: null-pointer crash!)
