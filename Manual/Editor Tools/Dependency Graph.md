...
The tool is also accessible from the console, for example, the following command: *asset.show_dependency_graph objects/stones/Stone_Small_C.cgf.cryasset* will open a new instance of the tool for the asset.
