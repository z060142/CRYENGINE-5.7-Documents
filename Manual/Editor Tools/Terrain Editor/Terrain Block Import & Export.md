...
To select terrain, click on the Terrain Editor on the right side of the screen. Then proceed to click
**
Edit->Select Terrain
**
 to access the terrain tool.
...
Similar to above, have your terrain area selected and then click
**
File -> Export Terrain Area with Objects
**
.
