...
The object meshes can be copied into the heightmap mesh at an early stage and become part of the terrain mesh that supports most of the heightmap properties, for example 3D terrain materials.
...
To activate this functionality, enable the **Integrate Objects** option under the ** Terrain**section of the** Level Settings**.

![Image](https://www.cryengine.com/docs/static/attachments/36308970)

Now go to the **Properties** of the entity and set the GI and Usage Mode to ** Integrate into Terrain**.
...
--- | --- | ---
*e_TerrainIntegrateObjectsMaxVerticesNum* | Preallocates a specified number of vertices to be used for the object's integration into terrain (per terrain sector)0 - disables the feature completely | Default is 30000 vertices
