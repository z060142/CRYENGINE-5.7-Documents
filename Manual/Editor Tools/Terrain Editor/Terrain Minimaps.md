...
[Preparing to Create a Mini Map](#preparing-to-create-a-mini-map)[Creating a Minimap](#creating-a-minimap)
...
You can edit this file, located in the `<root>\Editor\` folder, with a text editor. You can create a Mini Map by selecting the desired area, and then click Generate Mini Map, under Terrain Editor -> Mini Map.
...
*Pic1: Mini Map tab*![Image](https://www.cryengine.com/docs/static/attachments/32178863)
...
*Pic2: Selected area for creating a Mini Map* *![Image](https://www.cryengine.com/docs/static/attachments/32178864)*
...
*Pic3: Generating a Mini Map using the Terrain Editor*![Image](https://www.cryengine.com/docs/static/attachments/32178865)
