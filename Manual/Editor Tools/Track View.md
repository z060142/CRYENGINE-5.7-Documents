...
Sequences created with the Track View can be triggered in game with a specific [Flow Graph](Flow%20Graph.md) node. Different properties enable sequences to range from passive in game scenarios up to fully uncoupled cut-scenes.
...
The Menu can be accessed via the![Image](https://www.cryengine.com/docs/static/attachments/44966466) icon on the top-right corner of the Track View. When clicked, it reveals the followingsub-menus:
...
**Invert Scrubber Snapper Behavior** | Inverts the snapper behavior of the scrubber; e.g. when this it's active, snapping works as intended instead of being deactivated when the **ALT** key is pressed and vice versa. For more information about the snapping behaviors, please see the [Toolbar section](Track%20View.md#TrackView-toolbar) below.
Units |
...
--- | --- | ---
![Image](https://www.cryengine.com/docs/static/attachments/44107294) | **Unit display** | Shows where on the timeline you currently are.
![Image](https://www.cryengine.com/docs/static/attachments/44107239) | **Go to start of sequence** | Skips to the start of the sequence.
![Image](https://www.cryengine.com/docs/static/attachments/44107276) | **Play** | Plays the sequence.
![Image](https://www.cryengine.com/docs/static/attachments/44107289) | **Stop** | Stops the sequence.
![Image](https://www.cryengine.com/docs/static/attachments/44107240) | **Go to end of sequence** | Skips to the end of the sequence.
![Image](https://www.cryengine.com/docs/static/attachments/44107274) | **Loop** | Loops the sequence.
![Image](https://www.cryengine.com/docs/static/attachments/44107287) | **Set Playback Start** | Sets the start time for sequence playback and places a marker.
![Image](https://www.cryengine.com/docs/static/attachments/44107286) | **Set Playback End** | Sets the end time for sequence playback and places a marker.
![Image](https://www.cryengine.com/docs/static/attachments/44107226) | **Record** | Allows for recording of live keyframes within a timeline in your sequence.
![Image](https://www.cryengine.com/docs/static/attachments/44107250) | **Add Selected Entities** | Adds the selected entity object(s) to the currently active animation sequence in Track View. After objects are added, they can be animated and their properties can be changed as the playback continues. **Right-clicking** this button will reveal a list where users can set Tracks as default. This makes sure that the selected Tracks are automatically assigned to the entity when it's added to the list via the ** Add Selected Entities** button.
![Image](https://www.cryengine.com/docs/static/attachments/44107249) | **Sequence Properties** | User can edit the currently loaded sequence properties.
![Image](https://www.cryengine.com/docs/static/attachments/44107295) | **Zoom In** | Zooms in on the dopesheet.
![Image](https://www.cryengine.com/docs/static/attachments/44107296) | **Zoom Out** | Zooms in on the dopesheet.
![Image](https://www.cryengine.com/docs/static/attachments/44107251) | **Go To Previous Key** | Skips to the previous key of the currently selected track in both Dope Sheet Editor and Curve Editor.
![Image](https://www.cryengine.com/docs/static/attachments/44107272) | **Go To Next Key** | Skips to the next key of the currently selected track in both Dope Sheet Editor and Curve Editor.
![Image](https://www.cryengine.com/docs/static/attachments/44107252) | **No Snapping** | Disables snapping. Alternatively, holding Alt
![Image](https://www.cryengine.com/docs/static/attachments/44107273) | **Key Snapping** | Jumps to next or previous key when dragging playback progress indicator line.
![Image](https://www.cryengine.com/docs/static/attachments/44107292) | **Time Snapping** | Jumps to next or previous unit of time when dragging playback progress indicator line.
![Image](https://www.cryengine.com/docs/static/attachments/44965455) | **Move Keys** | Allows you to move the keys individually on the Dopesheet.
![Image](https://www.cryengine.com/docs/static/attachments/44107255) | **Slide Keys** | Allows you to slide all the keys on the same row to the left and right.
![Image](https://www.cryengine.com/docs/static/attachments/44107277) | **Scale Keys** | Allows you to scale keys relative to the cursor position.
![Image](https://www.cryengine.com/docs/static/attachments/44107259) | **Sync Selected Tracks to Base Position** | Syncs the selected tracks to the base position.
![Image](https://www.cryengine.com/docs/static/attachments/44107260) | **Sync Selected Tracks from Base Position** | Syncs the selected tracks from the base position.
...
![Image](https://www.cryengine.com/docs/static/attachments/44107229) On the left is a list showing the Nodes and Tracks contained within your track view sequence.

The search bar allows you to quickly find a specific node.

The![Image](https://www.cryengine.com/docs/static/attachments/44958713) button that is found next to the search bar allows you to add new Nodes. These Nodes can also be found on the list's **Context Menu**.
...
Button | Name | Description
--- | --- | ---
![Image](https://www.cryengine.com/docs/static/attachments/44107261) | **Set in and out tangents to auto** | Sets the tangents for the selected key(s) (the squares in the graph) to auto.
![Image](https://www.cryengine.com/docs/static/attachments/44107262) | **Set in tangent to zero** | Sets the in tangent for the selected key(s) (the squares in the graph) to zero.
![Image](https://www.cryengine.com/docs/static/attachments/44107263) | **Set in tangent to step** | Sets the in tangent for the selected key(s) (the squares in the graph) to step.
![Image](https://www.cryengine.com/docs/static/attachments/44107264) | **Set in tangent to linear** | Sets the in tangent for the selected key(s) (the squares in the graph) to linear.
![Image](https://www.cryengine.com/docs/static/attachments/44107265) | **Set out tangent to zero** | Sets the out tangent for the selected key(s) (the squares in the graph) to zero.
![Image](https://www.cryengine.com/docs/static/attachments/44107284) | **Set out tangent to step** | Sets the out tangent for the selected key(s) (the squares in the graph) to step.
![Image](https://www.cryengine.com/docs/static/attachments/44107283) | **Set out tangent to linear** | Sets the out tangent for the selected key(s) (the squares in the graph) to linear.
![Image](https://www.cryengine.com/docs/static/attachments/44107268) | **Fit curves horizontally** | Fits the graph into the graph window horizontally.
![Image](https://www.cryengine.com/docs/static/attachments/44107269) | **Fit curves vertically** | Fits the graph into the graph window vertically.
![Image](https://www.cryengine.com/docs/static/attachments/44107270) | **Break tangents** | Breaks the tangents for the selected key(s).
![Image](https://www.cryengine.com/docs/static/attachments/44107271) | **Unify tangents** | Sets the tangents for the selected key(s) to auto.

### 5. Properties

![Image](https://www.cryengine.com/docs/static/attachments/44958395)

On this panel, you will see a number of properties. Which properties you see depends on which key you have selected on the Dopesheet Events panel. For instance, if a position or rotation key is selected, the properties that are related to tangents for animation will appear. However, if an event key is selected, the properties related to which event it will use and what value that event should have will be displayed on the Properties panel.
...
**Out of Range** | - **Once** **-** Only play this track view sequence once. - ** Loop** **-** Loops the track view sequence once the end time is reached. - ** Constant** **-** Track view animation will continue after the track view is out of range. For example any moving objects will continue to move/rotate until they receive another input (e.g. from track view or Flow Graph).
...
**Incoming tangent type** | Lets you change the incoming tangent to one of the following types: - **Smooth** - ** Custom** - ** Zero** - ** Step** - ** Linear**
**Outgoing tangent type** | Lets you change the outgoing tangent to one of the following types: - **Smooth** - ** Custom** - ** Zero** - ** Step** - ** Linear**
**Flags** |
**Play on reset** | Sequence plays automatically when a level is started or player is dead and respawns.
**Cutscene sequence** | - Enables the Cut-Scene Toggles. - Enables skipping. - Helps with the transition to camera-control.
...
For more information about entity components, please refer to the [Entity Components](../Entities%20and%20Tools/Entity%20Components/Entity%20Components%20(From%20Engine%20Version%205.6).md) page.

[1. Menu](#1-menu)[2. Toolbar](#2-toolbar)[3. Dopesheet](#3-dopesheet)[4. Curve Editor](#4-curve-editor)[5. Properties](#5-properties)[Animating an Entity Component in Track View](#animating-an-entity-component-in-track-view)
