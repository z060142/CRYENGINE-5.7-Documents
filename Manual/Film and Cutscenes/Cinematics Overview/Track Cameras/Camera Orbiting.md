...
Use another (non-linked) camera and align it to the orbit camera at different points in time (use **Align to Object**). Even with a small number of keys you can easily recreate the orbit movement.

[Potential Problems with Rotation](#potential-problems-with-rotation)[Solution 1: Adjusting Pivot Rotation](#solution-1-adjusting-pivot-rotation)[Solution 2: Using a Different Setup](#solution-2-using-a-different-setup)[Using an Orbit Camera for Reference](#using-an-orbit-camera-for-reference)
