...
The following tutorial will guide you through the initial steps of getting your audio from CRIWARE ADX2 to work with CRYENGINE, using the [Audio Controls Editor (ACE)](../../../Editor%20Tools/Audio%20Controls%20Editor.md) and Audio System Controls.
...
To set a different path for your ADX2 project, select the **Edit → Preferences** option in the Audio Controls Editor's![Image](https://www.cryengine.com/docs/static/attachments/44966233) menu to open the Audio System Preferences dialog. Set the desired path by typing it in the **Project Path** field, or by using the![Image](https://www.cryengine.com/docs/static/attachments/44966234) button.

![Image](https://www.cryengine.com/docs/static/attachments/44966235) *Audio System Preferences*
...
![Image](https://www.cryengine.com/docs/static/attachments/44966236) *ACE Editor Header*

CRYENGINE 5.6 supports ADX2 version 2.19.00 and AtomCraft version 2.35.19.

### Creating an Audio Setup for CRYENGINE in ADX2

If you are new to ADX2, we recommend that you read the ADX2 [user manual](https://www.criware.com/en/products/adx2.html) or watch the official [video tutorials](https://www.youtube.com/playlist?list=PLx6UV6537TuiL42WUz9RkwRzhx47CZOIu) created by CRIWARE.
...
![Image](https://www.cryengine.com/docs/static/attachments/44967811) *FX/AISAC window*
...
![Image](https://www.cryengine.com/docs/static/attachments/44966247) *Build Atom CueSheet Binary*
...
- Download [crytek_audio_scripts.zip](/docs/static/attachments/44967814) and copy the custom script into a folder named *crytekscripts* within your AtomCraft project folder.
...
![Image](https://www.cryengine.com/docs/static/attachments/44966253) *Streaming Type*
...
![Image](https://www.cryengine.com/docs/static/attachments/44966256) *ACE*
...
Also ensure that the **Auto-Load** property of a created Preload is activated; the value of its ** Context** property meanwhile, can be left to ** Global**. More information on these properties can be found [here](/docs).
...
For each level, it is recommended that you create a dedicated layer in the [Level Explorer](../../../Editor%20Tools/Level%20Editor%20Tab/Level%20Explorer.md) for all your audio data.

- Open the Level Explorer using the **Tools → Level Editor → Level Explorer** option from the Editor's Main Menu.
- Select the **File → New Layer** option from the Level Explorer's![Image](https://www.cryengine.com/docs/static/attachments/52592719) menu to create a new layer. Double-click the layer to set it as the active.
...
![Image](https://www.cryengine.com/docs/static/attachments/44966337) *Active layer*
...
![Image](https://www.cryengine.com/docs/static/attachments/44966340) *Audio Trigger Spot*
...
Once the Audio Trigger Spot Entity has been placed, navigate to the **Play Trigger Name** field in the Editor's Properties panel. Click the![Image](https://www.cryengine.com/docs/static/attachments/44966234) button next to this field and select your created Trigger from the Select Audio System Control window that opens; your created Trigger should now play as soon as the Audio Trigger Spot Entity is enabled.

![Image](https://www.cryengine.com/docs/static/attachments/44966349) *Placed Audio Trigger Spot*
...
![Image](https://www.cryengine.com/docs/static/attachments/44966363) *Release*
...
![Image](https://www.cryengine.com/docs/static/attachments/44967804) *Action*
...
![Image](https://www.cryengine.com/docs/static/attachments/44967807) *Action Track*

Use prefixes in the names of Triggers or Cues to indicate whether they're used to start (*Play_...)* or stop (* Stop_...)* a sound.

[Initial Steps with ADX2 in CRYENGINE](#initial-steps-with-adx2-in-cryengine)[Creating an Audio Setup for CRYENGINE in ADX2](#creating-an-audio-setup-for-cryengine-in-adx2)[Connecting ADX2 Controls to Audio System Controls](#connecting-adx2-controls-to-audio-system-controls)[Placing an Audio Trigger in the Game](#placing-an-audio-trigger-in-the-game)
