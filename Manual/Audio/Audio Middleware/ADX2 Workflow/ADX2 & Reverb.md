...
Refer to [Audio & Reverbs*](../../Audio%20Overview/Audio%20%26%20Reverbs.md) for more information on audio Environments.
...
Select the created DSP Bus and add a reverb effect to its **Effects** section in the DSP Bus Setting Info. window by clicking the![Image](https://www.cryengine.com/docs/static/attachments/44967880) icon and selecting ** Atom Sound Renderer (ASR) → Reverb**. Similarly, click the![Image](https://www.cryengine.com/docs/static/attachments/44967880) icon in the DSP Bus' ** Sends** section and add a ** MasterOut.**

![Image](https://www.cryengine.com/docs/static/attachments/44967876) *Reverb effect*

*![Image](https://www.cryengine.com/docs/static/attachments/44967877)* * Master Out*
...
![Image](https://www.cryengine.com/docs/static/attachments/44967884) *Adding a BusSend called 'ReverbChurch'*
