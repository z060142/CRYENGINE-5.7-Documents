...
-
Add an AISAC Control under
**
Global Settings → AISAC-Controls
**
in the Project/Globals tree and name it
*
occlusion.
*
 Occlusion is calculated between 0-1 by default, with 1 being maximum occlusion.

-
Right-click the Cue that should be occluded and select the
**
...
-
Give the AISAC a name of your choice in the Add AISAC window that opens, and set the
**
...
Multiple AISACs can be combined using the same AISAC Control to create more complex behavior. For example, in this case, the
*
occlusion
*
