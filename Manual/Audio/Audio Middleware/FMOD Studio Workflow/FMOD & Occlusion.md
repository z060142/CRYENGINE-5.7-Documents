...
The first and simple way is to add a
*
FMOD Lowpass Simple
*
 or
...
occlusion p
*
arameter with a range from 0 to 1. You can leave the initial value at 0, which is set when the sound is not occluded.

-
In the
Occlusion Parameter
 tab, add automation for volume, lowpass filter or any other effect that should change the sound when it gets occluded.
