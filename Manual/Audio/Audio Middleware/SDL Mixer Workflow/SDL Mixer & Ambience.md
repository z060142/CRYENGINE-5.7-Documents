...
For the implementation of Ambient sounds using SDL-Mixer in CRYENGINE, the
*
Audio Area Ambience
*
 entity is used.
...
-
Enable Panning
 checkbox must be disabled (Required since the SDL-Mixer does not support sound spreading).
