...
Using the Character Tool you can precisely time sounds within an animation by creating
*
Animation Events
*
 on a timeline.
...
The Character Tool can be opened by going to
...
Animation Events
*
 in order to execute audio Triggers at certain points on the timeline.

-
The
Play
 button cycles the animation allowing you to choose the moment at which you would like a particular
*
Animation Event
*
 to play.
...
-
Move the slider to that time position. For fine tuning, use
Shift
 and
Ctrl
.
...
-
For zooming the timeline, hold
Ctrl
 and scroll with the mouse-wheel.

-
By double-clicking in the timeline a new
*
Animation Event
*
 is created.
...
Animation Events
*
 you can play the Animation to audition the sound setup.

-
The timing can now be adjusted by clicking the
*
Animation Event
*
 and moving it on the timeline or by adjusting the value in the Animation Events list.
...
`
ca_SkeletonEffectsPlayAudioInEngine
`
 to
**
anything other than 0
**
. This will enable audio_trigger Animation Events to be handled by the Engine.
