...
In [Flow Graph](../../../Editor%20Tools/Flow%20Graph.md), you can communicate directly to and from a prefab instance just like an entity by using prefab events. Just create an event inside a prefab, give it a name and then reference the prefab instance as you normally do an entity.
