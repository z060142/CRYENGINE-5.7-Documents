...
*.ocm
**
Once the above steps have been followed, click
**
Save,
**
 this will then generate the Level Occluder Mesh.
...
Inside the Woodland level, go to the Level Explorer and disable all layers except
**
Level_Occ_Mesh
**
 and
