...
**
 |
Maximum possible physical acceleration that the AI entity can move at.
 |
...
**
 |
Sets the distance from the camera that we will start rendering from (by default 0.25 meters).
 |
...
**
 |
Additional controls to the density of the fog volume.
 |
...
**
 |
Direction of the fall off (longitude). 0 = East (Positive X).
 |
...
**
 |
Mass of the object in kg. Note: Mass cannot be set at the same time as density.
 |
...
**
 |
Determines how this light interacts with Global Illumination.
 |
...
**
 |
Whether to use a capsule for the default geometry, otherwise a cylinder.
 |
...
**
 |
Air resistance for the character.
 |
...
**
 |
A larger value gives a greater dampening effect, whereas a value of 0 gives no dampening effect.
 |
...
**
 |
A larger value gives a greater dampening effect on acceleration, whereas a value of 0 gives no dampening effect.
 |
...
**
 |
Maximum angle the character can climb.
 |
...
**
 |
Maximum angle the character can jump at.
 |
...
**
 |
Minimum angle before the character starts sliding.
 |
...
**
 |
Minimum angle before the character starts falling.
 |
...
**
 |
The minimum angle for the primary axis that the object will be constrained to.
 |
...
**
 |
The maximum angle for the primary axis that the object will be constrained to.
 |
...
**
 |
The minimum angle for the other axes that the object will be constrained to.
 |
...
**
 |
The maximum angle for the other axes that the object will be constrained to.
 |
...
**
 |
Whether the constrained object will be allowed to rotate.
 |
...
**
 |
Minimum position that the entity can be moved to form the constraint pivot. A unit of -1 indicates that the minimum position is one meter behind the entity.
 |
...
**
 |
Determines how far the constrained object can move to the left.
 |
...
**
 |
Determines how far the constrained object can move to the right.
 |
...
**
 |
Determines how far the constrained object can move to the top.
 |
...
**
 |
Determines how far the constrained object can move to the bottom.
 |
