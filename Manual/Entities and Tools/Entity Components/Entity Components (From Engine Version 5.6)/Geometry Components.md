...
**
 |
Determines the play speed of the animation.
 |
...
**
 |
Whether this component will ignore VisAreas.
 |
...
**
 |
Defines if this component will ignore Terrain Layer Blending.
 |
...
**
 |
Defines if this component will ignore Decal Blending.
 |
