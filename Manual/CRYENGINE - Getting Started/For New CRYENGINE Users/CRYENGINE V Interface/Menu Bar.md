...
To export succesfully, the
CVar e_StreamCgf
 should be set to
0
. Changing this setting should be done either
*
before loading your level
*
, or can alternately be
*
manually changed in the system.cfg file
*
.

To make the engine use the exported files in your game, go to
...
**
 ...
 |
Closes the Editor,
prompting the user to save before exiting,
...
**
 |
Renames the selected Engine element.
 |
...
Reload All
**
reloads all prefabs inside the level with the "on-disk" version. Only useful if prefabs are set to not automatically update.
...
Select Invert
**
deselects all selected objects and selects everything else
...
locks selection so the objects can't be deselected and no other objects can be selected
...
is a filter for selection where users can specify what type of objects needs to be selectable
...
akes selected object ignored from selection process
**
...
unlocks all objects from being "frozen"
 |
...
Reset To Default
**
 resets the material on the object to the default one assigned
...
Get From Selected
**
 gets the material from the selected object to the
...
Pick Material
**
 lets you pick any surfaces and then display the surface material
...
**
 ...
 |
Lets you regenerate all the cubemaps in a level when you select
**
Regenerate All Cubemaps
**
 option.
...
Get Physics State
**
takes the state of any
*
currently selected
*
 entity/entities and makes it permanent in the level. Typically used in AI/physics mode, when letting the object simulate and store its physically correct state. Most useful for ragdolls, since it stores their current pose.
...
Simulate Objects
**
enables physics on any
*
currently selected
*
 entity/entities
in order to place the assets according to the laws of physics.
For example, to make a vehicle "sit" correctly
on a surface
according to its mass and suspension.

-
**
Generate Breakable Joints
**
allows users to take a compound (multiple node) CGF and generate joints between its touching
...
F2
**
) and turns on the single mode rendering.
...
Custom
**
 mode is activated when you change any display settings in the presets mentioned above.
 |
...
Display Info -
**
 toggles Display Info on/off.

-
**
Verbosity Level Low/Medium/High -
**
 displays a low/medium/high amount of information when Display Info is on.
 |
...
Remember Location
**
 allows you to save 10 locations that you later recall using the Goto Location Feature.

This is useful to quickly jump to different predefined places in Sandbox and in Game (
**
Ctrl+F1,2,3,4 etc
**
).
...
Go to Location
**
 lets you jump to the locations saved under
**
Remember Location
**
.
...
Sequence Camera
**
 is used when you want to see through the
...
**
 is the camera entity that you have
...
Cycle Camera
**
 lets you cycle through the above cameras.
 |
...
**
 |
Switches between the windowed mode and the full screen mode.
 |
...
**
 ...
 |
Switches to Game Mode so that you can play the level within the editor (
**
Ctrl+G
**
).
...
**
 ...
 |
Enables Physics and AI in Edit mode so that users don't need to jump in-game to see how they behave
(
**
Ctrl+P
**
...
Mute Audio:
**
 Sets the volume of sounds to 0 in the engine.
...
**
**
 Reloads all audio data and sends a signal to the audio middleware indicating that the entire audio system is refreshing.
**
...
**
 |
NavMeshes are automatically updated in real time while the level is edited.
 |
...
**
 |
NavMeshes are automatically updated when the changes made to a level's geometry have not been registered for a specific duration of time. This duration can be controlled by the
**
ai_NavmeshStabilizationTimeToUpdate
**
 CVar (default is 0.3 sec).
 |
...
To apply the changes made to a level's geometry and to update NavMeshes when
**
Navigation Update Mode
**
 has been set to
...
Disabled,
**
 use the options of the
**
Game → AI → Regenerate Navigation
**
 menu.

 |

If your Editor is running slowly, setting the
**
Navigation Update Mode
**
 to
...
**
 ...
 |
**
Regenerate Pending Changes
**
 |
Enabling this option updates those parts of NavMeshes that have been changed after the
**
Game → AI →
**
**
...
**
 |
Updates the NavMeshes of all Agent Types.
 |
...
**
 |
Only the NavMeshes of the selected Agent Type are updated.
 |
...
**
 |
Lists available Agent Types, allowing users to select those Types for which debug information is displayed in the Viewport. A
gent types must be defined in the
...
**
 |
When enabled, accessible areas of a NavMesh are marked blue while unreachable areas are grayed out in the Viewport.
 |
...
**
 |
Regenerates all Cover Surfaces placed in a level.
 |
...
Reduce Working Set
**
removes as many pages as possible from the working set of the Sandbox process.

-
**
Update Procedural Vegetation
**
forces regeneration of procedural vegetation.
 |
...
Create Object
**
opens the Create Object tool.

-
**
Level Explorer
**
 opens the Level Explorer.

-
**
Level Settings
**
 opens the Level Settings.
...
**
 Console
opens the Python Interactive Console.
...
Character Tool
**
 opens the Character Tool.

-
**
Facial Editor
**
opens the Facial Editor tool.

-
**
Mannequin Editor
**
opens the Mannequin Editor tool.
 |
...
**
 ...
 |
Opens the FBX Importer tool that loads

animations, skeletons, skins and static geometry meshes.
...
**
 -
 opens the Substance Archive Graph Editor.
...
**
 -
 opens the Substance Graph Default Mapping Editor
...
**
 -
 opens the Substance Instance Editor
 |
