...
Time:
**
 Shows the current frametime taken up by an instance
...
Latest Peaks:
**
 Shows any recent in frametime over a certain value for any functions shown; the purple number to the left displays the number of recent pagefaults caused by the engine

-
**
Pagefaults:
**
 happen when the game engine runs out of memory and the operating system accesses the hard drive.
 |
...
Render Resources
**
displays various statistics about DirectX use.

**
Draw Calls per Object
**
shows the number of draw calls needed to draw an object.

**
Render Budgets
**
shows information about CPU/GPU time and memory spent per frame
