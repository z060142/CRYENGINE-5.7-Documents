...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/23308616
- Page ID: 23308616
- Breadcrumb: CRYENGINE - Getting Started > For New CRYENGINE Users > CRYENGINE V Basics > Viewport Navigation
...
**
 S
**
 keys to go forwards and backwards and
**
A
**
 or
...
While moving around the Viewport with the WASD keys, the speed of movement can be increased or decreased in real-time by scrolling the
**
mousewheel
**
 upwards or downwards respectively.

You can also change the movement speed by clicking
**
Camera
**
...
Q
**
, you can turn on Terrain Collision. When turned on, the camera will not move below the terrain, but slide along it.
