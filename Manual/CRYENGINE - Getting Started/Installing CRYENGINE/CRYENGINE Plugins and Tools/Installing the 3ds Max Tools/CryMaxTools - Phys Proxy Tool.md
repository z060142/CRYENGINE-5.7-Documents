...
- Set the **Material ID** spinner to the number of the sub-material that you want the proxy to use:
...
- Hit one of the buttons in the row of the **Box** button to create proxies.
...
**UDPs** | Additional user string for the Proxy's User Defined Properties. Separate by spaces. [**See here for details**.](../../../../Asset%20Prep%20(External)/Asset%20Exporting%20Overview/Geometry%20Creation%20Overview/Geometry%20Metadata%20(UDP).md)
...
[First Steps](#first-steps)[Parameters and Characteristics](#parameters-and-characteristics)[Known Limitations and Characteristics:](#known-limitations-and-characteristics)
