...
**
 in the center of the dashboard to be redirected to the CRYENGINE
Asset Database
in your web browser.
...
Asset Database
**
hyperlink on the left panel of the Launcher.
...
-
Select the asset you want to use and then click
**
Add to Library
**
...
-
Once there, head to the Asset Library
...
-
Copy the sub-folders in the
*
Assets
*
 folder of the asset download and paste them into the the sub-folder that corresponds to the downloaded asset's type in your CRYENGINE project's
*
Assets
*
folder.
...
Projects
**
 tab in the CRYENGINE Launcher.

-
Click the  icon besides a listed project and select the
**
Reveal in Explorer
**
