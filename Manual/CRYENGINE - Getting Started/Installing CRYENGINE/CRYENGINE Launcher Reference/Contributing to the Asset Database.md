...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/69468288
- Page ID: 69468288
- Breadcrumb: CRYENGINE - Getting Started > Installing CRYENGINE > CRYENGINE Launcher Reference > Contributing to the Asset Database
- Parent: CRYENGINE Launcher Reference

## Content

If you would like to publish your own assets on the Asset Database so that they can be used by other CRYENGINE developers in their projects, you will first need to set up a Contributor account.
...
Contributor Assets
**
 tab in the CRYENGINE Launcher and click the
**
Contributor Account
**
...
*
prior to becoming a Contributor
*
*
...
Asset Title
**
 is the name of the asset visible in the CRYENGINE Asset Database; the
**
Asset Name
**
 on the other hand is used in the URL of the asset.

-
You will then be directed to the dashboard pictured below; complete the
**
Description, Technical Specifications, Images
**
 and
**
Embed Media
...
Versions
**
 section below in the dashboard, as shown:
...
-
Click it and enter the number of your asset version in the
**
New Asset Version
**
 dialog that opens; click
**
Submit
**
 to proceed.
...
-
In the following dashboard, upload your asset folder and click
**
Submit Version
**
...
-
In the following dashboard, the status of the asset submission should be visible in the
**
Versions
**
 section as shown:
...
**
 |
New asset version created; waiting for files to be uploaded.
 |
...
**
 |
Files uploaded and queued to be packaged.
 |
...
**
 |
There was an issue with the packaging process.
 |
...
**
 |
The package is waiting to be reviewed by the CRYENGINE team.
 |
...
**
 |
The package is currently being reviewed by the CRYENGINE team.
 |
...
**
 |
The package passed review process but has not yet been published on the CRYENGINE Asset Database.
 |
...
**
 |
The package is waiting to be published on the CRYENGINE Asset Database.
 |
...
**
 |
There was an issue with the publishing process.
 |
...
**
 |
The package has been published on the CRYENGINE Asset Database.
 |
...
**
 |
The package failed the review process.
 |
...
-
You can cancel a submission by clicking  beside your asset package in the
**
Versions
**
 section, and selecting
**
Cancel Submission
**
from the menu.
