...
[Chapters:](#chapters)[Using Reference Images](#using-reference-images)[Troubleshooting](#troubleshooting)[Video Tutorial](#video-tutorial)
...
Copy/paste the attached [RGBChart.bmp](/docs/static/attachments/1212829) into the reference image. It is important to use the color chart supplied with this document, as otherwise the resource compiler later on won't be able to detect and extract the chart.
...
See also [this](http://youtube.com/watch?v=Ecq2YTlJM-8) video tutorial on our YouTube channel.
