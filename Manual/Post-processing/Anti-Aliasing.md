...
--- | ---
**r_AntialiasingMode 1** | Enables SMAA without any temporal filtering.
**r_AntialiasingMode 2** | Enables SMAA with temporal filtering.
**r_AntialiasingMode 3** | Enables SMAA with temporal filtering and projection matrix jittering to further improve quality.
...
CVar/Command | Description
--- | ---
**r_AntialiasingMode 4** | Enables temporal supersampling (without SMAA).
...
Cvar/Command | Description
--- | ---
**r_SuperSampling 0/1** | Disables/enables supersampling.
**r_SuperSampling 2** | Enables 2x2 supersampling.
**r_SuperSampling 3** | Enables 3x3 supersampling.

Supersampling can also be used in combination with the image-based AA techniques to further improve image quality.

[Subpixel Morphological Antialiasing (SMAA) and Temporal AntiAliasing](#subpixel-morphological-antialiasing-smaa-and-temporal-antialiasing)[Temporal Supersampling Antialiasing (TSAA)](#temporal-supersampling-antialiasing-tsaa)[Supersampling](#supersampling)
