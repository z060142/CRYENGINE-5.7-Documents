...
*Pic1: Selecting an entity in the Flow Graph editor.*![Image](https://www.cryengine.com/docs/static/attachments/52593326)

This procedure works only if an entity has been selected in the Perspective viewport. The context menu option,**Add Graph Default Entity**, adds the entity's node that has been already created in the Flow Graph.
...
*Pic2: Adding a component node using the context menu.*![Image](https://www.cryengine.com/docs/static/attachments/52593327)
...
*Pic3: Performing search function using the QuickSearchNode.*![Image](https://www.cryengine.com/docs/static/attachments/52593328)
...
*Pic4: Editing the node parameters using the Inputs tab.*![Image](https://www.cryengine.com/docs/static/attachments/52593329)
...
*Pic5: Editing the parameters directly on the nodes.*![Image](https://www.cryengine.com/docs/static/attachments/52593330)

[Entity Nodes](#entity-nodes)[Component Nodes](#component-nodes)[Deleting Nodes](#deleting-nodes)[Moving and Arranging Nodes](#moving-and-arranging-nodes)[Copying Nodes](#copying-nodes)[Editing Nodes](#editing-nodes)
