...
When a graph is imported, the nodes that do not have target entities displays a red **Choose Entity** highlight.
...
- **Right-click** anywhere in the main editing pane, and then got to **Selection -> Export Selected Nodes**.
...
- Open the context menu by **right-clicking** the main editing pane, and then selecting ** Import**.
- Select the .xml file that contains the graph, and click **OK**to finish importing the graph. You can also **right-click** directly inside the Flow Graph window and import the graph from there:
