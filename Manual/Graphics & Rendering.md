...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/44959220
- Page ID: 44959220
- Breadcrumb: Graphics & Rendering
...
The rendering system features a linear HDR pipeline, [Physically Based Shading](Graphics%20%26%20Rendering/Shaders/Physically%20Based%20Shading%20(PBS).md) (PBS), [Dynamic Lighting](Graphics%20%26%20Rendering/Lighting.md), [High Quality Post Processing](Post-processing.md) and [Anti-aliasing](Post-processing/Anti-Aliasing.md), all heavily optimized to run efficiently on current-generation platforms.
