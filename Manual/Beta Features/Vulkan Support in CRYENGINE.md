...
It is a low-overhead, cross-platform 3D graphics library that gives developers more control over the GPU and lower level CPU usage for their Android-based mobile projects. In the following topic, we will go over how you can enable and use Vulkan in your CRYENGINE projects.
...
have
been tested on 1.0.46 version onwards.
...
system.cfg
**
 file and edit it using a text editing software (
**
Notepad++
**
).
...
system.cfg
**
file, add or change the cvar directive
*
**
r_Driver=(X)
**
...
cfg
**
 file, and restart the CRYENGINE editor.
