...
[Enabling the Debug Mode](#enabling-the-debug-mode)[How it Works](#how-it-works)[Not all Assets are Created Equal](#not-all-assets-are-created-equal)[Scaling](#scaling)[Why Give me 3 Buttons (256, 512 & 1024), if 512 is the Desired Setting?](#why-give-me-3-buttons-256-512-and-1024-if-512-is-the-desired-setting)
