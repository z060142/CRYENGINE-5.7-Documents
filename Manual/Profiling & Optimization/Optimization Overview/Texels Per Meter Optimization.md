...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/25535458
- Page ID: 25535458
- Breadcrumb: Profiling & Optimization > Optimization Overview > Texels Per Meter Optimization
...
Generally an Artist would make an object to the exact scale that the object is designed to be at in the game world. However, for variation within scenes, for example with rocks, trees etc., the
**
Scale Tool
**
