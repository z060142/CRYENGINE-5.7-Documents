...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/44966384
- Page ID: 44966384
- Breadcrumb: Profiling & Optimization > Profiling Overview > Debugging and Profiling Tools > DisplayInfo Icons
- Parent: Debugging and Profiling Tools
...
There are several information icons that you may see during your use of the Sandbox Editor. The information below will help you identify and understand what each icon means.

This information can be displayed or hidden with the
**
r_DisplayInfo 0/1
**
 CVar.
