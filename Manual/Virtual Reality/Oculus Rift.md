...
[Chapters:](#chapters)[Getting Started](#getting-started)[Input Configuration](#input-configuration)[Flow Graph](#flow-graph)[Oculus Rift-Specific Console Commands and Variables](#oculus-rift-specific-console-commands-and-variables)[Possible Issues You Can Encounter](#possible-issues-you-can-encounter)

### Getting Started

- **Drivers:** Install the most up to date drivers - **[Available from Oculus](https://developer.oculus.com/downloads/)**. We currently support version ** 1.3 Beta.**
- **Oculus Documentation:** Please read the documentation regarding device setup and configuration - **[Available from Oculus](https://developer.oculus.com/documentation/)**.
- **Health and Safety:** Please carefully read the H&S information - **[Available from Oculus](http://static.oculus.com/sdk-downloads/documents/Oculus_Health_and_Safety_Warnings_0.5.0.pdf)**.
...
- **Recommended PC Specs:** Information regarding hardware requirements - **[Available from Oculus](https://www.oculus.com/en-us/blog/the-rifts-recommended-spec-pc-sdk-0-6-released-and-mobile-vr-jam-voting/)**.
...
- Remove all VR plugins from your.cryproject for e.g. *{ "type": "EPluginType::Native", "path": "CryOculusVR" }*. **NOTE:** This includes VR plugins related to HMD's from all other manufacturers, not just the Oculus Rift
...
See **[Setting up Controls & Actionmaps](../../API%20Reference/CRYENGINE%20Game%20Code/Miscellaneous%20Game%20Code/Setting%20Up%20Controls%20and%20Action%20Maps.md)** for more information.
...
- **VR:Tools**
**![Image](https://www.cryengine.com/docs/static/attachments/56000785)***VR:Tools node*

Allows you to hookup an input to trigger the RecenterPose command.

- **VR:ControllerTracking**
**![Image](https://www.cryengine.com/docs/static/attachments/56000787)***VR:ControllerTracking node*
...
- **VR:OculusController**
**![Image](https://www.cryengine.com/docs/static/attachments/56000788)***VR:OculusController node*
...
- **VR:QuadRenderLayer**
**![Image](https://www.cryengine.com/docs/static/attachments/56000789)***VR:QuadRenderLayer node*
...
**![Image](https://www.cryengine.com/docs/static/attachments/56000791)***VR:RenderLayerTexture node*
...
**hmd_projection** | Variable | 0 | Selects the way the image is projected into the HMD:0 - normal stereoscopic mode 1 - monoscopic (cinema-like) 2 - monoscopic (head-locked) ***Used with Oculus SDK 1.2 or above only***
**hmd_perf_hud** | Variable | 0 | Performance HUD Display for HMD's0 - off 1 - Summary 2 - Latency timing 3 - App Render timing 4 - Compositor Render timing 5 - Version Info ******Used with***Oculus SDK 1.2 or above only***
...
- Remove any VR plugins from your.cryproject for e.g. *{ "type": "EPluginType::Native", "path": "CryOculusVR" }*.
- Remove *sys_vr_support* from your system.cfg or.cryproject
- Ensure that any other VR specific features are disabled
