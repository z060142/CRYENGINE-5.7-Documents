...
- [Common 3ds Max Export Errors](Troubleshooting and Debugging Assets/Common 3ds Max Export Errors.md)
...
CRYENGINE expects a specific vertex index format to be provided for each asset. The specific format is compile-time selectable, it's either 16-bit or 32-bit (see vtx_idx in
`
ProjectDefines.h
`
), this would be considered the "Native" format, according to the engine.
...
Warning:
**
... caused by file 'objects/characters/human/us/officer/hands.chr'
*

This is a pretty ambiguous error usually stemming from the fact that the file does not exist in the path a CDF was looking for. In the case above, someone has moved the hands.chr from the path in the error to the
`
Objects\Characters\Human\Hands
`
...
Warning:
**
 Character LOD mismatch. The bone number 52 is different. LOD0 Bip01 R Finger12 LOD3 Bip01 L Foot
*
...
Warning:
**
 ... caused by file 'objects/characters/heads/story/laurence_barnes/barnes.chr'
*
...
Warning:
**
 Character LOD mismatch. The bone number 53 is different. LOD0 Bip01 R Finger21 LOD3 Bip01 L Toe0
*
...
Warning:
**
 Character LOD mismatch. The bone number 54 is different. LOD0 Bip01 R Finger22 LOD3 Bip01 L Heel
*
...
Warning:
**
 Failed to Load Character, Different bone amount of LOD0 and LOD1
*
...
Warning:
**
 ... caused by file 'objects/characters/heads/story/laurence_barnes/barnes_lod1.chr'
*
...
Warning:
**
 Model objects/characters/heads/story/laurence_barnes/barnes_lod1.chr has duplicated joints Bip01 L Clavicle
*
...
Warning:
**
 Model objects/characters/heads/story/laurence_barnes/barnes_lod1.chr has duplicated joints Bip01
*
...
Warning:
**
 Model objects/characters/heads/story/laurence_barnes/barnes_lod1.chr has duplicated joints Bip01 R Finger22
*
...
Warning:
**
 several updates per frame: FrameID: 211df
*
...
Warning:
**
 ... caused by file 'objects/characters/human/us/nanosuit/nanosuit_us.chr'
*
...
[Image: /docs/static/attachments/23994925]
...
[Image: /docs/static/attachments/23994920]
...
[Image: /docs/static/attachments/23994924]
...
[Image: /docs/static/attachments/23994933]
...
[Image: /docs/static/attachments/23994918]

##
Degenerate Faces

[Image: /docs/static/attachments/23994917]

##
Material Not Set to Crytek Shader

[Image: /docs/static/attachments/23994916]
...
[Image: /docs/static/attachments/23994911]

It is good practice to not export things into the game that have transformations applied to them. This warning is just a reminder.
**
Reset Xform
**
 will solve this.
...
[Image: /docs/static/attachments/23994910]
...
[Image: /docs/static/attachments/23994934]
...
The character has to be exported when in
**
Figure Mode
**
 or he will have some serious weighting issues in Character Editor. The screenshots above were taken to demonstrate this.

**
NOTE:
**
 Remember that the first frame of the current rigging animation looks exactly like figure mode.
...
`
User\Shaders\Cache\CGPShadersGame\Shaders\Cache\CGVShaders
`
...
[Image: /docs/static/attachments/23994922]
...
To change the path, change the line
*
<Animation Path="exported folder in animations directory"/>
*
 in the .cba file.
...
Note:
**
 The exporter traverses upward to locate the .cba file from the exported directory.

##
No Bones to Export

[Image: /docs/static/attachments/23994923]
...
[Image: /docs/static/attachments/23994912]
...
[Image: /docs/static/attachments/23994931]

[Image: /docs/static/attachments/23994930]
...
[Image: /docs/static/attachments/23994929]
...
[Image: /docs/static/attachments/23994921]
...
[Image: /docs/static/attachments/23994932]

[Image: /docs/static/attachments/23994928]
...
[Image: /docs/static/attachments/23994926]
...
[Image: /docs/static/attachments/23994913]
...
[Image: /docs/static/attachments/23994914]
...
*
**
 and it will produce an error message if there is something wrong with your scene setup. If everything is setup OK, you will get a
[/docs/static/engines/cryengine-5/categories/23756816/pages/23308045#TroubleshootingandDebuggingAssets-DiagnosticsOK](
Diagnostics OK
)
 message!
...
[Image: /docs/static/attachments/23994940]
...
[Image: /docs/static/attachments/23994915]

To set the right path, go to
**
*
Crytek > Exporter Properties
*
**

[Image: /docs/static/attachments/23994919]

##
No CryExportNode found!

[Image: /docs/static/attachments/23994938]

Make sure you go to
**
*
Crytek > Create CryExportNode
*
**
 to create a CryExportNode.

##
Empty CryExportNode found

[Image: /docs/static/attachments/23994936]
...
*
Any object that is NOT a child of the CryExportNode will NOT be exported.
*

##
Rename DefaultLib Material Library

[Image: /docs/static/attachments/23994941]
...
[Image: /docs/static/attachments/23994939]

No CryShader on "CryExportNode_NodeName.MeshObject" object! Material: Scene_Material

Make sure you convert the object's material to Cryshader by selecting it and using
**
*
Crytek > Convert selected materials to CryShader
*
**
...
[Image: /docs/static/attachments/23994937]

There is a hole in MaterialIDs list in Sources.Materials.materialname

[Image: /docs/static/attachments/23994927]
...
*
You also need to have material in the right order. You cannot have a material ID of number 13 without having the preceding numbered materials.
*

##
Diagnostics Successful

[Image: /docs/static/attachments/23994935]
