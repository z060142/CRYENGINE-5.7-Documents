...
[Sections](#sections)[General Setup in DCC Tools](#general-setup-in-dcc-tools)[Debugging](#debugging)
...
![Image](https://www.cryengine.com/docs/static/attachments/35400749) *Fence consisting of instanced elements (instances are blue).*
...
**r_GeomInstancing** ``` Toggles HW geometry instancing. Usage: r_GeomInstancing [0/1] Default is 1 (on). Set to 0 to disable geom. instancing. ```
