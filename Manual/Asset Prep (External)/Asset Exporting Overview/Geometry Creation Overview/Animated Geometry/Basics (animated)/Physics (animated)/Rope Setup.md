...
**
:
 By indexing the Chainname, it is possible to use several chains/rope objects in one file. It is useful to double-click select the root bone of the chain (will select all children) and use the 3ds Max Renaming Tool.

**
For Maya Users
**
:
 Be sure to parent a polygon to the root of the rope with a proxy no draw material assigned to it and the following naming conventions: Rope1_Seg01_physShape
