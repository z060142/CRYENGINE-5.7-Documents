...
entity_id_1
**
 - Entity ID that the 1st rope end is tied to (-1 if statically tied to world, -2 if not tied at all).

-
**
entity_part_id_1
**
 - Entity part ID that the first rope end is tied to.

-
**
end1 (vector)
**
 - The first end attachment point (if unspecified, it is assumed to be the current end point position).

-
**
end2 (vector)
**
 - The second end attachment point.

-
**
check_collisions
**
 - 1 if the rope should collide with the environment (otherwise, 0).

-
**
coll_dist
**
 - Rope thickness for collision detection.
...
character collision
**
 – Y axis active, will collide with the local character.

-
**
environment collision
**
 – X axis active, will collide with the environment.

-
**
joint limit
**
 – Spring tension x, this will be the per-bone rotational limit for the chain.
