...
You can define the joint names required for Aim IK. You can refer to to learn how to create your aim poses.
...
For Limb IK, you can specify the joint names here. Please check for more information on Limb IK.
...
For Look IK, you can specify the eye attachment names, the animation token used and the joints influenced. Please check for more information on how to setup the animation assets for Look IK.
...
[CHRPARAMS Definitions](#chrparams-definitions)[Character Animation Lists](#character-animation-lists)[Creating.chrparams file using Python Script](#creating-chrparams-file-using-python-script)
