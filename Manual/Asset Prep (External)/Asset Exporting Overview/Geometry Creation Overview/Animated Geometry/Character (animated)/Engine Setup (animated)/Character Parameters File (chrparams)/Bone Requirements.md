...
eye_left_bone
**
 – placed where the pivots of the left eye should be.
...
eye_right_bone
**
 – placed where the pivots of the right eye should be.
...
Bip01 L Heel
**
 – This bone needs to be placed at the base of the foot in the location where the heel of the character should be.

**
Bip01 L Toe0
**
 – This bone is used for the front part of the foot/toes.
