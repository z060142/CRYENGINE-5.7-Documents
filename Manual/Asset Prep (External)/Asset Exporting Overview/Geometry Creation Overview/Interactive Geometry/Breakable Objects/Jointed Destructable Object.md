...
Jointed Destructible Objects can be set up to break in to smaller pieces when being detached from the joint. For example a wooden sign falls off of the signpost **and** breaks into several planks. The object properties must contain the information about the pieces used. The pieces need to be linked to the object that was formerly whole. The pieces must also be referenced in the Object properties/UDP of this object.

Before reading this topic, make sure you have gone through the documentation for creating [Jointed Breakable Objects](/docs/static/engines/cryengine-5/categories/23756816).

### Setup in 3ds Max

#### Sample 3ds Max file

- [jointedDestructable.rar](/docs/static/attachments/23994741)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994719)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994717)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994718)
...
- [dissolve_breakable_maya.ma](/docs/static/attachments/23994722)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994744)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994724)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994725)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994726)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994742)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994730)

Here you can specify the pieces that the ***sign*** mesh object will break into: ** pieces=_piece01_group, _piece02_group**
...
- [BreakableTable.scn](/docs/static/attachments/23994720)

#### Hierarchical Setup

The CryExportNode is the top node that contains the export properties for the object.

![Image](https://www.cryengine.com/docs/static/attachments/23994731)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994732)
...
![Image](https://www.cryengine.com/docs/static/attachments/23994733)

Notice, the ***Table_top*** mesh object has multiple mesh objects as its children. These are the pieces that the ***Table_top*** mesh object will break into after it's disjointed.

Here is a screenshot that shows how the pieces look:

![Image](https://www.cryengine.com/docs/static/attachments/23994734)

#### Custom Properties

You need to add a Node User Properties to the ***Table_top*** mesh object.

![Image](https://www.cryengine.com/docs/static/attachments/23994735)

Here you can specify the pieces that the ***Table_top*** mesh object will break into: ** pieces=_piece1,_piece2,_piece3,_piece4,_piece5,_piece6,_piece7,_piece8,_piece9,_piece10,_piece11,_piece12**

For each piece, add a Node User Properties by selecting the mesh and going to ***Crytek > Node User Properties***.

You can assign a mass to each piece.

![Image](https://www.cryengine.com/docs/static/attachments/23994736)
...
Start by placing a BreakableObject in your level from the **RollupBar > Entity > Physics** directory.

![Image](https://www.cryengine.com/docs/static/attachments/23994737)

Then, with the BreakableObject selected, change the **Model** from the Entity Properties.

![Image](https://www.cryengine.com/docs/static/attachments/23994738)

Now set up the table's textures in the Material Editor

![Image](https://www.cryengine.com/docs/static/attachments/23994739)

Finally, test the table by shooting in game mode.

![Image](https://www.cryengine.com/docs/static/attachments/23994740)

[Setup in 3ds Max](#setup-in-3ds-max)[Setup in Maya](#setup-in-maya)[Setup in XSI](#setup-in-xsi)
