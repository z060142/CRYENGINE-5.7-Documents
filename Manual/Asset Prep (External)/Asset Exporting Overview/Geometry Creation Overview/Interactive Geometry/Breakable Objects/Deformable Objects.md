...
**
 ...
 |
If any edge is stretched more than that, its length is re-enforced. max_stretch = 0.3 means stretched to 130% of its original length (or by 30% wrt to its original length). default 0.01
...
**
 ...
 |
Sphere radius in skinning assignment. Default is the minimum of the main mesh's bounding box's dimensions (see below)
