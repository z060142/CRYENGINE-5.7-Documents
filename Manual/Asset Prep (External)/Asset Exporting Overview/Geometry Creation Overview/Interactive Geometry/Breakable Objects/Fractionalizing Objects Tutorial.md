...
**2.** Create a few cutter objects. Avoid objects that have no volume because these can cause a lot of mesh garbage. Make sure that the cutter objects have proper UV coordinates and material IDs. These will be used in the debris pieces. (You can use the attached [procutter_example.zip](/docs/static/attachments/23994771).)
...
**1.** First, load the object that you want to fractionalize in Maya.![Image](https://www.cryengine.com/docs/static/attachments/23994767)

**2.** Create a few objects you wish to use as the "cookie cutter". Make sure that the cutter objects have proper UV coordinates and material IDs. These will be used in the debris pieces.![Image](https://www.cryengine.com/docs/static/attachments/23994768)

**3.** Select the first cutter object and then select your main mesh.![Image](https://www.cryengine.com/docs/static/attachments/23994769)

**4.** Next go to mesh, Booleans, then you have a few choices but in most cases you will just use intersection. You will likely need to duplicate this asset multiple times for each new piece you want to have.![Image](https://www.cryengine.com/docs/static/attachments/23994770)
...
[Fractionalizing Objects in 3ds Max](#fractionalizing-objects-in-3ds-max)[Fractionalizing Objects in Maya](#fractionalizing-objects-in-maya)
