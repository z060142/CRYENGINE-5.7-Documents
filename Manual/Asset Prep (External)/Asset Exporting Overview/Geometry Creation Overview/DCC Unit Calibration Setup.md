...
Simply set up a 1x1x1m Designer object and go to
**
Level -> Export Selected Objects
**
. Then in the
**
Save As
**
 dialog box, make sure to set the file type to
**
*.obj/*.fbx.
**
...
Inside 3ds Max, the unit setup can be found under the menu
**
Customize
**
...
Right-click the Snaps Toggle area under the menu bar and go to the 3rd
**
Home Grid
**
...
There is also a very useful way to get the measurement feedback

directly from the Engine.

Simply create a 1x1x1m designer object and go to
**
Level menu -> Export Selected Objects
**
 and save the file type as either an
**
*.obj
**
 or
...
The unit setup can be found under
**
...
Settings
**
 in the left column. Here, you have to set the
**
Working Units
**
 to centimeter or the exporter will post a warning on export.
...
When you configure the unit scale of the DCC tool to match with CRYENGINE, setting the unit value scale to
**
cm
**
 or
