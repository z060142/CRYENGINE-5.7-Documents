...
- To pathfind, the AI character must be of an [agent type](Navigation%20Configuration.md) supported by the navigation mesh.
...
[Sections](#sections)[Time-slicing](#time-slicing)[Testing](#testing)
...
Other debugging tools are described at this [LINK](Navmesh%20Debugging.md).
