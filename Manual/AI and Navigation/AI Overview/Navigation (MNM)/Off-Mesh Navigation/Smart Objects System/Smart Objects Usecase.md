...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/29798752
- Page ID: 29798752
- Breadcrumb: AI and Navigation > AI Overview > Navigation (MNM) > Off-Mesh Navigation > Smart Objects System > Smart Objects Usecase
- Parent: Smart Objects System
...
[Sections](#sections)[The Idea](#the-idea)[Getting Started](#getting-started)[More Complex Examples](#more-complex-examples)[Combining Smart Objects with Static Flow Graphs](#combining-smart-objects-with-static-flow-graphs)[Debugging Smart Objects](#debugging-smart-objects)
...
- Make sure to create that new action graph file in the `Libs\ActionGraphs` sub-folder (parallel to the GameData.pak file), otherwise it will not show up in the list!
- If the `Libs\ActionGraphs` sub-folder does not exist, then you will have to create it.
...
![Image](https://www.cryengine.com/docs/static/attachments/24000921) *The worker, the crate to be carried, and a pallet as a destination*
...
![Image](https://www.cryengine.com/docs/static/attachments/24000920) *Rule for bringing a crate to a delivery place*
...
**ai_DebugDraw** ``` Toggles the AI debugging view. Usage: ai_DebugDraw [-1/0/1] Default is 0 (minimal), value -1 will draw nothing, value 1 displays AI rays and targets and enables the view for other AI debugging tools. ``` ** ai_DrawSmartObjects** ``` Draws smart object debug information. Usage: ai_DrawSmartObjects [0/1] Default is 0 (off). Set to 1 to draw the smart objects. ```
