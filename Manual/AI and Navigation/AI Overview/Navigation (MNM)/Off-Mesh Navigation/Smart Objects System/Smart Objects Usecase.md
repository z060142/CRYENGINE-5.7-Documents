...
Libs\ActionGraphs
`
 sub-folder does not exist, then you will have to create it.
...
Central
**
: Create the rule once in the Smart Objects editor and it will be available in every level in the whole game.
