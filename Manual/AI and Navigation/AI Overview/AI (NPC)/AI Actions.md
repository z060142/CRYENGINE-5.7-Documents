...
[Sections](#sections)[Setup](#setup)[Example](#example)
...
- You will be prompted to save that AI Action under a new XML file. Name the file however you want (for example "**sample1.xml**") and make sure it's in the `GameSDK\Libs\ActionGraphs\` directory (you may need to create the directory if it doesn't exist already)
