...
Go to
**
Create Object -> Legacy Entities -> Others -> Spawnpoint
**
 and drag it into your scene.

-
Select the Spawnpoint, open Flow Graph, click on the flowQuickStart graph and then click
**
RMB
**
 and choose
...
Add Selected Entity
**
 to add the Spawnpoint with its properties.
...
Spawnpoint
**
 node and jump into game (
**
Ctrl+G
**
) to see we spawn at that origin.
