...
- Enable the Debugger within the Flow Graph interface by clicking the **Bug** icon in the top left menu. After doing so, jump into game mode (** Ctrl+G**) to activate the visual debugging in the graph.
...
- To clear the debugging information from the graph you will need to exit game mode and then click the **Trash** icon.
