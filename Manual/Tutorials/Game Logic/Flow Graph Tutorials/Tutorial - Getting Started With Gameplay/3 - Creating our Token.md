...
**
Tools->Database View tool
**
 and then click the
**
GameTokens
**
 tab to see the default interface.

-
Once inside we will be clicking Add Library and naming the library
**
gameQuickStart
**
 then clicking
...
-
We can also now Set the variable type to be
**
Int
**
 or
...
0
**
 directly below. You can finalise all changes by now clicking the
**
Save
**
...
-
This will be the last step to actually writing our a GameToken and now we will pivot back over to Flow Graph and create a Graph Token. Within the Flow Graph interface you will find the Graph Token creation housed in the
**
Tools->edit Graph Tokens
**
... button in the upper menu.

-
Once clicking this we are presented with a
**
popup
**
 window that requires us to enter in the
**
Name
**
 and
...
variable type
**
 just like the GameToken workflow. We will enter in the name
**
graphScore
**
 to not confuse us when looking to make sure they are registered in the next step.

-
Now that we have registered our tokens we will expose them using a simple
**
Mission:GameToken
**
