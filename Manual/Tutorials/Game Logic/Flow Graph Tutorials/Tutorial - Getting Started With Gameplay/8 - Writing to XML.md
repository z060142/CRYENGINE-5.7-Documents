...
-
Map
 - This is the default location in the levels folder

-
Game
 - Saves to your game directory

-
Root
 - Saves to the engine root directory
...
You need to follow these below mentioned steps to successfully create an
.xml
from Flow Graph:
...
**
 node and add the
**
killCount Graph Token
**
 we made earlier.

-
Connect the second output port to fire every second, not every frame, into the
**
Trigger
**
 port of the
...
A
**
 port of the node and a value of
**
3
**
 added to the
...
XML:NewChild
**
 node to add the attribute of
**
Score
**
 to my document by feeding the
**
Success
**
 output port of the
...
-
Set the value once more by taking the
**
Out Value
**
 from the
...
Mission:GameTokenGet
**
 node early on and pass this into a
**
Value
**
 input port of a
...
Execute
**
 ports. Name the document whatever you wish and keep in mind the locations listed above.
