...
- Right click the *Game.cryproject* file and select**Generate Solution**
- Navigate to your **Solutions** directory in the same directory. Open the ** win64** directory, containing ** Game.sln**
- Double click your **Game.sln** file to open the solution with Visual Studio. Once opened, you should have a view similar to image 2 below.
