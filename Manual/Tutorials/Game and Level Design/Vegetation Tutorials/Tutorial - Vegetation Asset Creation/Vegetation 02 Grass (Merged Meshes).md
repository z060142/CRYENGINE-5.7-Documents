...
If you want to find information about using the **Vegetation Editor** in CRYENGINE, please go **[HERE](../../../../Editor%20Tools/Vegetation%20Editor.md).**

![Image](https://www.cryengine.com/docs/static/attachments/24157039) *Pic 1: Scene from Crysis 3 merged mesh grass*
...
![Image](https://www.cryengine.com/docs/static/attachments/24157038) *Pic 2: Example texture for a grass group used in the above scene in Crysis 3*
...
[General Guidelines](#general-guidelines)[Breeze Generation](#breeze-generation)[Debug Information](#debug-information)[Tutorials](#tutorials)
