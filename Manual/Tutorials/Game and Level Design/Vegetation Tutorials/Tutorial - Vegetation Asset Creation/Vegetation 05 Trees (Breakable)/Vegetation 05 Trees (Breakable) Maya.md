...
To start with you may choose to open the tutorial Maya scene with just only the geometry assets created: "
**
palm_tree_start.ma
**
"

If you want to see what you are suppose to create in the next 15 - 30 minutes, you may choose to open the final Maya scene: "
**
palm_tree_final.ma
**
"
...
First, we will create the shaders for the vegetation object parts. In Maya, open the "
**
HyperShade
**
". Create a new material group called "tutorial_boolean_destruction_maya". Then create four shaders which we need to add as sub-materials to the material group. Name the first SubId "leaves_SUB", the second one "trunk_SUB", the third SubId "touchbending_proxy_SUB" and the fourth one "obstruct_SUB".
...
Key to success of setting up
**
Boolean destructible vegetation
**
 is having the correct "
**
Physicalize"
**
 extra attribute for the material/shader.

Use the "
**
Add Attribute
**
" button of the Maya to CRYENGINE Exporter to add this "Physicalize" attribute to the shaders.

When it comes to the material creation process in Maya to CRYENGINE, we must add the "Physicalize" extra attribute to the shaders. In "
**
crytek
**
" shelf open the "
...
Add Attribute
**
" button in any way, you have to check the "
**
Extra Attribute"
**
...
leaves_SUB
*
 shader (ID: 01) in Maya's Attribute Editor.

Set the extra attributes you added as "
**
Physicalize: None
**
"
...
*
Optional: Assign the texture map files to the Color texture slots to s
*
how textures in Maya's viewport.
...
>\Assets\
`
Objects\tutorial\vegetation\05\tree\boolean_destruction\maya\
**
tutorial_boolean_leaf_diff.tif
**
`
>
`
...
Pic06:
*
Set the Physicalize extra attribute for sub material ID 03
*
*
*
*
...
Touch Bending
**
 setup of the leaves, you must pay attention to the correct
**
naming
**
of the
...
Pic07:
*
Set the Physicalize extra attribute for sub material ID 04
*
*
*
*
...
This
physics
obstruct parameter in the sub-material is used to define how much air resistance this object has. The amount of air resistance is defined through the size of the obstruct volume. The larger the
obstruct
 volume, the slower the tree will fall.
...
**
 section, set the diffuse color to green and reduce the opacity to 15 - 30%. This isn't required, but helps the user to quickly identify the obstruct geometry within the asset.
...
Finally, we will export an
*
*.MTL
*
 file to our project folder to finish our material setup part to this path:
...
Objects\tutorial\vegetation\05\tree\boolean_destruction\maya\
**
tutorial_boolean_destruction.mtl
**
`
...
Create your tree trunk geometry and apply
the material
(
*
tutorial_boolean_destruction.mtl
...
to it
.
Change its material SubId to 2 ("trunk"). F
inally u
se the
**
Unwrap UVW
**
 modifier to adjust its UV shell.
...
Next create a single big leaf mesh for your palm tree
and a
pply the material
(
*
...
to it
. C
hange its material SubId to 1 ("leaves").
Finally u
se the "Unwrap UVW" modifier to adjust its UV shell to only fit around one of the leaves on the texture.
...
To achieve even more believability to our asset we will be using our
Detail Bending
...
Using CRYENGINE exporter to export
the Maya files
:
...
shelf
**
 or create an empty group and name it to "cryExportNode_
**
palm_tree
**
".
...
bold
**
 sub-string part is the file name it gets created. So the *.CGF file is named "palm_tree.cgf".

-
Create under this root export node a group named "
**
boolean_destructible_tree
**
_group". The
**
bold
**
 sub-string part becomes the asset name shown in CRYENGINE Sandbox:
**
boolean_destructible_tree
**
...
branch#_# locators
**
, the leaf and trunk meshes, proxy/obstruct mesh geometries all under the "
**
boolean_destructible_tree
**
_group" node.
...
boolean_destructible_tree
**
_group" node and go down to its extra attribute section and mark this group to be exported as *.CGF format.
