...
*Pic1: Touch bending in action (with physics debug info displayed: F10 or p_draw_helper=1)*![Image](https://www.cryengine.com/docs/static/attachments/26510090)
...
- No-collide proxy and proper material setup are necessary for this system to work.
- Touch Bending can only be activated within the no-collide volume.
...
[Helpful Information](#helpful-information)[Tutorials](#tutorials)
