...
*![Image](https://www.cryengine.com/docs/static/attachments/26509595) Pic1: Dense grass field affected through wind*

*![Image](https://www.cryengine.com/docs/static/attachments/26509594) Pic2: Two assets that this entire grass field contains*
...
- The three locators need to follow the naming convention rules for Merged Mesh to recognize them: "**branch1_1" (bottom), "branch1_2" (mid) and "branch1_3"** (top).
- Use the **Local Scale** attribute in the shape node of your locator if you want to change their display size.
...
![Image](https://www.cryengine.com/docs/static/attachments/24157054) *Pic3: This is the final exportable scene hierarchy*
...
![Image](https://www.cryengine.com/docs/static/attachments/24157055) *Pic4: Setting a new Material Group and adding a shader to this material group*
...
![Image](https://www.cryengine.com/docs/static/attachments/24157056) **Pic5: Generate a standard material for export. This will be finalized inside CRYENGINE material editor later**
...
![Image](https://www.cryengine.com/docs/static/attachments/24157057) *Pic6: grass blade geometry with their UVs tweaked to match the grass texture*
...
- **branch1_1** - bottom locator
- **branch1_2** - mid locator
- **branch1_3** - top locator
...
![Image](https://www.cryengine.com/docs/static/attachments/24157058) *Pic7: Export ready scene hierarchy*
