...
Set
**
net_dedicatedServerArbitratorPort=<port>
**
 in system.cfg to a sensible value.
...
Set
**
net_dedicatedServerArbitratorIP=<address>
**
 to the arbitrator's IP address.
...
net_dedicatedServerArbitratorPort=<port>
**
 to the arbitrators listen port.

-
Set
**
gl_serverIsAllocatedFromDedicatedServerArbitrator=1
**
 to inform the lobby it is an arbitrated server.
...
Set
**
gl_getServerFromDedicatedServerArbitrator=1
**
 to inform the lobby that it should request a server from the arbitrator on Start Match.
...
-
**
net_dedicatedServerArbitratorListFreeServers
**
 - list servers the arbitrator has to allocate.
...
levelrotation.xml
**
 is present when the arbitrator is run, it will load, create and advertise it's own session using this, try to avoid this.
