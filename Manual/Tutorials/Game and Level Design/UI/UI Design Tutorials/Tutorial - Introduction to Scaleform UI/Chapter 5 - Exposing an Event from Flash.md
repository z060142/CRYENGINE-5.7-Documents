...
-
A new window will appear for your Symbol contents; here, draw a simple rectangle using the
...
-
Next, open the Actions Window either by pressing
**
F9
**
 or going to Window → Actions in the menu; add the following code after your existing code in Scene 1 → Layer 1: Frame 1:
