...
By default we will be using a GFx exporter to compile our SWF file; the GFx exporter is located in the
*
Tools
*
 folder of the CRYENGINE build you have installed.
...
-
Start by first saving your Flash file in the UI folder of your project, for example,
*
<root>/Assets/libs/UI
*
.
...
-
Next, create a custom shortcut to the
*
gfxexport.exe
*
 file, so that it will generate any necessary images used in your Flash project. Add
`
-i DDS
`
 to the end of the new shortcut's
**
Target Path
**
...
The GFx Export tool for Scaleform 3 can be found at

*
<root>/Tools/GFxExport/Scaleform3/gfxexport.exe
.
*
...
-
Start by saving your Flash file in the UI folder of your project, for example,
*
<root>/Assets/Libs/UI.
...
-
Then, create a custom shortcut to the
*
GFxExport1.exe
*
 file so that it will generate any necessary images used in your Animate project. Add
`
-i DDS
`
...
The GFx Export tool for Scaleform 4 can be found at
*
