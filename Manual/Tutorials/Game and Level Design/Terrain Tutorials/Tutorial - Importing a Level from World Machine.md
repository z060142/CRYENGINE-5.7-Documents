...
First off, know the scale you are working with. Under
**
World Commands -> Project World Parameters
**
you can see how WM is setting up the scale.
...
Specify the location where you want to save it and c
lick the
**
W
**
...
rite output to disk!
**
button to create the file. We
 are now ready to create the colormap.

##
Creating the Colormap

Next we are going to have to add a few more nodes into the WM graph. These will allow us to
save out the file
, color the
colormap and
preview the data in WM before we export
.
...
-
Finally but not required, is the
**
Overlay View
**
node. This helps you visualize the height and color maps together inside WM. This is also found in
**
...
Inside the colorizer node (double-click to open) you can pick
one of the presets
from the drop-down list to get you started. This is enough for now to apply some color onto the terrain.
...
Bitmap Output
**
node to open its properties. The file type CRYENGINE accepts for the terrain colormap is
**
BMP
**
.

So set the exported file type out as BMP. Click the
**
...
You have now created all the files you need for CRYENGINE; we have created
from World Machine:
...
Or if you create your own terrain textures / materials, make sure you set the shader type to
**
Terrain.layer
**
 from the default
...
Materials\terrain
`
 folder you can see the available terrain materials.
...
-
Next we will add another Terrain Layer. Right-click in the section oft he Terrain Editor where your "Grass" layer is and choose
**
Create Layer
**
...
To overwrite
the texture we imported from WM, without adding the high detail
**
uncheck
**
 the
