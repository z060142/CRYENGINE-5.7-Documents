...
**
`
YOUR_PROJECT_FOLDER\Assets\Levels\<level name>\leveldata\objectives.xml
`
**
.
...
Now that you have set up an XML file, go to the
**
Create Object
**
 tool and click on
...
**
. You can then drag this MissionObjective entity into the level.
