...
- Go to **Create Object -> Legacy Entities -> Physics** and grab the ** Gravity Box** to add it to the Viewport and scene.
- With the Gravity Box entity selected, scroll to the bottom of its properties to adjust the gravitational influence. As the default world is set to **-13** we can change the influence of the Gravity Box to something like ** 100** to see the effects of our player floating in the space.
