...
Mass
**
 - The weight of the object (the density of the object multiplied by its volume). This can be calculated as Mass = (Density * Volume).

-
**
Water Density
**
 - This can be used to override the default water density (1000). Lower values assume that the body is floating in the water that's less dense than it actually is, and thus it will sink more easily.
...
**
 and drag the entity into the scene.
...
Resting
**
 checkbox and making sure it is no longer resting. Next we will be setting the
**
Mass
**
 to
...
100.
**
You should now jump into the game and shoot the ball to see it applying a physical impulse to roll away.

-
Lastly, for the sake of interaction you also have the ability to make your Entity
**
Usable
**
 and display a
...
Use Message
**
. In the image shown it uses the name "COLLIN" which will print out to the screen inside of a global radius.
