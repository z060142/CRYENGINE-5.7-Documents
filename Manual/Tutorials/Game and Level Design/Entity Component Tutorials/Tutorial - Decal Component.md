...
This tutorial is going to explain the decal components and how to use it. With the decal component, you can add decals to your scene, this technique is mostly used to add blood splatter, dirt or bullet holes dynamically to already existing geometry. I would also recommend seeing the [Entity Components](../../../Entities%20and%20Tools/Entity%20Components.md) documentation to understand or look up what the specific attributes do.
...
*Opening the asset browser*![Image](https://www.cryengine.com/docs/static/attachments/28254495)

Drag and drop the.tif file into the asset browser

*Importing the decal texture*![Image](https://www.cryengine.com/docs/static/attachments/28254502)

Now we have to add a new material, open the [Material Editor Legacy](../../../Editor%20Tools/Material%20Editor%20Legacy.md) under **Tools → Material Editor**. Right-click on any folder and select "Add New Material" in the context menu.

*Adding a new material*![Image](https://www.cryengine.com/docs/static/attachments/28254497)
...
*Adding the texture to the material*![Image](https://www.cryengine.com/docs/static/attachments/28254503)
...
*Creating the entity and adding the decal component*![Image](https://www.cryengine.com/docs/static/attachments/28254500)
...
*Selecting the decal material*![Image](https://www.cryengine.com/docs/static/attachments/28254504)
...
*Moving the entity around*![Image](https://www.cryengine.com/docs/static/attachments/28254505)
...
*Changing the projection depth*![Image](https://www.cryengine.com/docs/static/attachments/28254506)
...
*Changing the transformation of the component*![Image](https://www.cryengine.com/docs/static/attachments/28254507)
...
Now we have to add a new material, open the [Material Editor Legacy](../../../Editor%20Tools/Material%20Editor%20Legacy.md) under **Tools → Material Editor Legacy** or the new Material Editor under ** Tools → Material Editor**. Right-click on any folder and select "Add New Material" in the context menu.
