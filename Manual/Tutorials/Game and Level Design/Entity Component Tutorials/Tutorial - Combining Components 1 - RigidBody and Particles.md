...
However, before you get started you should be aware that we work with Schematyc in this tutorial, so if you are unfamiliar with Schematyc or maybe just need a memory refresh, then you can find the Schematyc documentation
...
,
[/docs/static/engines/cryengine-5/categories/23756816/pages/28181729](
Tutorial - Particle Emitter Component
)
,
[/docs/static/engines/cryengine-5/categories/23756816/pages/44965986](
...
. Hence, we recommend that you familiarize yourself with each of those Components first and before attempting this tutorial.

You will also need to download the
[/docs/static/attachments/28254533](
fire.pfx
)
 to your project's Asset folder (anywhere in the folder will suffice). Normally this file will be downloaded into your Downloads Folder, hence you will need to copy/move it to your project's Asset folder.

Finally, the image below shows what the result of this tutorial will look like.

[Image: /docs/static/attachments/28254520]

First, we need to create the Entities for this tutorial and since we are going to use
[/docs/static/engines/cryengine-5/categories/23756816/pages/36868211](
Schematyc
)
, then we have to create two new schematyc Entities.
...
Tools -> Asset Browser
**
 and right click somewhere in the Asset Browser window. Create two new "Schematyc Entities", one named "particle" and the other "particle_trigger". After giving an Entity a name a popup will ask if you want to choose a base, in this case we don't, so say no.

[Image: /docs/static/attachments/28254534]
...
-
We will now add a Particle Effect (the fire particle you downloaded earlier to your project's Asset folder) to the "particle" Entity. First, Select the Particle Emitter Component, then go to the Asset Browser. The fire effect should be visible in the Asset Browser, but if it's not then go to
**
Edit -> Generate/Repair All Metadata
**
, this is basically is a refresh.
...
[Image: /docs/static/attachments/28254535]
...
[Image: /docs/static/attachments/28254536]
...
[Image: /docs/static/attachments/28254537]
...
[Image: /docs/static/attachments/28254538]
...
[Image: /docs/static/attachments/28254539]
...
[Image: /docs/static/attachments/28254540]

-
In this example the geometry of the Mesh Component and the Sensor Volume have both been changed to a sphere, for a reminder of how to change the geometry of a Mesh, then see step 3 in the
[/docs](
Mesh Component
)
 documentation. The "ball" Entity is now complete and so the Schematyc Editor can be closed. Now drag the "particle_trigger" Entity from the Asset Browser into your level and place it a little bit above the "particle" Entity.

[Image: /docs/static/attachments/28254541]
...
[Image: /docs/static/attachments/28254542]
