...
Create a new material by clicking the
**
Add New Item
**
 button:
...
You can also add a material by right-clicking the folder in the Material Editor you want to add it to. A context menu will be displayed, where you can select
**
Add New Material
**
:
...
To create a multi-material, right-click the
the folder in the Material Editor you want to add it to
 and select
**
...
*
 ...
 You now have to set the number of
**
Sub Materials
**
/
...
Right-click the material that you created and select
**
...
If you want to copy a specific material from a certain object or brush, you can select that object or brush (1) and click the
**
...
**
 right-click
**
 on one of the parameters to bring up the context menu (2). Now select
**
Copy All
**
:
...
Similar to before, right-click over the parameters of your material to open the context menu and this time select
**
Paste
**
:
...
If you now select a different object (in our example the cylinder on the left) (1), right-click on your material and choose
**
Assign to Selected Objects
**
 (2), you should see those
parameters
...
Copy Category
**
 function to copy individual categories such as the
**
Lighting Settings
**
 or
...
Texture Maps
**
 categories if you only wish to copy specific content from one material to another while keeping the other content untouched.
