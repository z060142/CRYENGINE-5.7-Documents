...
Material Editor
**
 in CRYENGINE Sandbox (or start CRYENGINE Sandbox if it's not yet running).
...
Add Attributes
**
 button on the export window will add the physics options to the shaders 'Extra Attributes'. Use Maya's
**
Attribute Editor
**
 to edit them.
...
Add Attributes
**
 you can click the Crytek Panel then the
**
Mat.Ed
**
 Icon to open the Material Groups editor.
...
Create New Group
**
 and begin adding Shaders from the Hypershade.

-
Once you are done with your material you can go back to the
**
Crytek Export
**
 window and click
...
**
 to create a material file in the same folder as the scene is saved.
...
In the CRYENGINE Sandbox Editor you can open the
**
Material Editor
**
 by going to
...
Add New Item
**
 in the toolbar to create a new material.

*
Pic9: Add New Item in Material
*
*
Editor
*
...
Save
**
, your new material will be created with a set of default values and you can modify/save the file directly from the
**
Material Editor
**
.
