...
The first step is to install [SkyPaint](http://www.skypaint.com) and its Photoshop plugin in the right directory.
...
In order for your skybox to properly be recognized in Sandbox you will need to save the files in a certain way, please refer to [Skybox Texture Setup](/docs/static/engines/cryengine-5/categories/23756816) for more information.
