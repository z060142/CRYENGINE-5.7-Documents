...
![Image](https://www.cryengine.com/docs/static/attachments/24156141) The Character Tool window will update the changes made.
...
As a follow-up to this blendshape tutorial we will continue with a wrinkle map setup which will add more detail: **[Tutorial - Wrinkle Map Setup](../../../Digital%20Content%20Creation/Tutorial%20-%20Wrinkle%20Map%20Setup.md)**.
...
[Creating the Character](#creating-the-character)[Assigning the Material](#assigning-the-material)[Assigning the Animations](#assigning-the-animations)[Summary](#summary)[Engine CVars](#engine-cvars)[Tangent Updates](#tangent-updates)
