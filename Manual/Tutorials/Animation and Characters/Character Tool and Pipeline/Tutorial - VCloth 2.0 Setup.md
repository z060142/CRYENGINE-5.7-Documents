...
- Source: https://www.cryengine.com/docs/static/engines/cryengine-5/categories/23756816/pages/25530479
- Page ID: 25530479
- Breadcrumb: Tutorials > Animation and Characters > Character Tool and Pipeline > Tutorial - VCloth 2.0 Setup
...
*![Image](https://www.cryengine.com/docs/static/attachments/44958304)*

**2.** Add a new attachment:

![Image](https://www.cryengine.com/docs/static/attachments/44958311)

**3.** Name the Attachment and set ** Type** to ** VCloth 2.0 Attachment**:

![Image](https://www.cryengine.com/docs/static/attachments/44958305)
...
The cloth bindings you will set in the following steps must fit to the character you have chosen. This means the cloth **must** be skinned according to the characters joints (see **[How To - Export VCloth from Maya to CRYENGINE](../../../Physics/VCloth%202.0/How%20To%20-%20Export%20VCloth%20from%20Maya%20to%20CRYENGINE.md)**). Otherwise the cloth will not work. This means you cannot simply change clothes between different characters. If the characters have different joints, you need to re-skin the cloth for each character separately.
![Image](https://www.cryengine.com/docs/static/attachments/35955798)
...
Collision handling is fulfilled by using Lozenges as collision proxies - these are flexible geometric objects which can be set up using only four numbers. Using Lozenges, spheres, capsules, boxes and other geometrical objects can be described. To see how Lozenges can be setup in CRYENGINE see this link: **[Setup of Lozenges](../../../Editor%20Tools/Animation%20Tab/Character%20Tool/Attachment%20System%20Tutorial%20-%20Character%20Tool.md#AttachmentSystemTutorial-CharacterTool-LozengeSetup)**.
...
![Image](https://www.cryengine.com/docs/static/attachments/44958319)

- In the properties, click **Attachments -> Add**
**![Image](https://www.cryengine.com/docs/static/attachments/44958320)**
- A new attachment is created. Now you can name it:
![Image](https://www.cryengine.com/docs/static/attachments/44958321)
...
![Image](https://www.cryengine.com/docs/static/attachments/44958323)
...
![Image](https://www.cryengine.com/docs/static/attachments/44958334)
...
![Image](https://www.cryengine.com/docs/static/attachments/44958324) *![Image](https://www.cryengine.com/docs/static/attachments/44958336)*
...
*![Image](https://www.cryengine.com/docs/static/attachments/44958338)*

A simple floor proxy moves with the characters and works well for flat surfaces.

![Image](https://www.cryengine.com/docs/static/attachments/44958327)
...
Parameters in **Animation Control**do not directly affect the simulation, but are more for controlling behavior in certain situations (See **[here](../../../Editor%20Tools/Animation%20Tab/Character%20Tool/Character%20Tool%20-%20Properties%20Panel.md)**).
...
![Image](https://www.cryengine.com/docs/static/attachments/44958329)
...
![Image](https://www.cryengine.com/docs/static/attachments/35955800)
...
*Different Draw Vertices Radius Sizes: 0.01 (left), 0.02 (middle), 0.04 (right) - colors indicate the strength of confinement![Image](https://www.cryengine.com/docs/static/attachments/44958330)*
...
*Stretch links (Parameter: 1); Right: Stretch, Shear, Bend links (Parameter: 4)![Image](https://www.cryengine.com/docs/static/attachments/44958331)*

*Bending triangles![Image](https://www.cryengine.com/docs/static/attachments/44958332)*
...
*![Image](https://www.cryengine.com/docs/static/attachments/44958333)*
...
**[VCloth 2.0 properties](../../../Editor%20Tools/Animation%20Tab/Character%20Tool/Character%20Tool%20-%20Properties%20Panel.md)**

[Setting Up the Character](#setting-up-the-character)[Collisions](#collisions)[Tweaking Parameters](#tweaking-parameters)[Performance Improvements](#performance-improvements)[Visual Feedback/Debugging](#visual-feedbackdebugging)
