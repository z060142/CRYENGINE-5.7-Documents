...
![Image](https://www.cryengine.com/docs/static/attachments/24003491) *Pic1: In-game shot of the broken glass panes achieved using the Breakable Glass technology*
...
*![Image](https://www.cryengine.com/docs/static/attachments/24003492) Pic2: Wireframe of the glass panels inside 3ds Max*
...
![Image](https://www.cryengine.com/docs/static/attachments/24152039) *Pic3: The full material setup for the bus stop asset with 8 SubIDs*
...
![Image](https://www.cryengine.com/docs/static/attachments/24151998) *Pic4: Proxy ID Setup in 3ds Max*
...
Here is the important step that controls the breakable glass. We are not creating a separate proxy for the breakable glass, we are Physicalizing the visible mesh as we need the exact 1 to 1 link between the visible mesh & the physics system.
![Image](https://www.cryengine.com/docs/static/attachments/24151999) *Pic5: 1st Breakable Glass ID (advertisements) Setup in 3ds Max*
...
![Image](https://www.cryengine.com/docs/static/attachments/24152044) *Pic6: 2nd breakable glass material ID (main panels) in 3ds Max*
...
![Image](https://www.cryengine.com/docs/static/attachments/24152048) *Pic7: Material setup for ID 4,5,6,7 (non-physicalized SubIDs)*
...
This one **shouldn't** be physicalized since, as mentioned before, we can't use breakable glass on curved surfaces!
...
*![Image](https://www.cryengine.com/docs/static/attachments/24003497) Pic8: Material selected at the top level, ready for export*
...
*![Image](https://www.cryengine.com/docs/static/attachments/24003498) Pic9: Hierarchy setup*
...
To follow the rules of asset creation for CRYENGINE, we have made an LOD for the bus stop. This is a simplified model of the original mesh (LOD 0). Again the LOD should be linked to the parent object (the visible mesh) which is then linked to the helper dummy.
...
*Pic10: Screenshot of the individual Glass material sub-ID's inside CRYENGINE*![Image](https://www.cryengine.com/docs/static/attachments/26512845)
...
Now select the Glass_Ribbed (ID 3) and assign it the **Glass_breakable_safetyglass_small** and lastly for Glass_unbreakable (ID 8) change it to** Glass_unbreakable**.![Image](https://www.cryengine.com/docs/static/attachments/26512846) * Pic11: Screenshot of the Glass material set up with the right shader and surface type*

If you have properly set up your Shader and Surface Type you should now have fully breakable glass panels in your scene.

[Prerequisites for this Tutorial](#prerequisites-for-this-tutorial)[Helpful Information](#helpful-information)[Initial 3ds Max Setup](#initial-3ds-max-setup)[Material](#material)[Export the Material](#export-the-material)[Object Setup](#object-setup)
