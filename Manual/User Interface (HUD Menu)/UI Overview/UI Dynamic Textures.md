...
[Sections](#sections)[Material Setup](#material-setup)[Interaction on Dynamic Textures](#interaction-on-dynamic-textures)

### Material Setup

It is possible to Display any UIElement as a dynamic texture on objects.

To do so you have to create a new material and setup the Diffuse texture with the name of the UIElement and assign this material to your object.

The Diffuse texture name simply uses the name of the element plus the.ui extension. You also have to change the TexType to "Dynamic 2D-Map".
