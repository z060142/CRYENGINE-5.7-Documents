...
On the frontend side, the particle system presents a modular
 setup approach, that allows for flexible design of particle effects that can be set up to interact with the rest of the engine though attribute passing.
