...
The blending can be enabled with the
Blendlayer
 checkbox. Once active, several new shader parameters will show up:
...
Blend Mask Tiling
 ...
 |
DEPRECATED -
Specifies how often the blend layer textures are repeated (tiled).

If you use heightmap that aligns with your base normal map, this parameter should usually be set to exactly 1.0, otherwise, the blend layer textures are rotated to make them appear less repetitive.
...
Second Diffuse Map
 ...
 |
Diffuse map of blend layer (with the specular mask in alpha).

*
In CRYENGINE 3.4 or earlier, this is the "Custom" slot.
*
...
*
In CRYENGINE 3.4 or earlier, this is the "[1] Custom" slot.
*
...
*
In CRYENGINE 3.4 or earlier, this is the "Opacity" slot.
*
