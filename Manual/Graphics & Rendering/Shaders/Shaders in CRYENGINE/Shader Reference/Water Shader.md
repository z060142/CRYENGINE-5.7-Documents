...
-
When setting up water materials for an ocean, ensure
*
water volume
*
 option is
...
-
When setting up water materials for water volumes or rivers, ensure
*
water volume
*
 option
...
The following Shader Generation Paramaters are available for the
**
Water
**
 Shader:
...
Normals
**
 setup (inc. detail normals scale)
