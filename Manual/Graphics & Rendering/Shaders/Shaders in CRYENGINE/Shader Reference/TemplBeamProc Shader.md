...
-
Although the shader doesn't seem to produce shadows, check the
**
No Shadow
**
 option to make sure.
...
**
 ...
 |
Scaling factor. If the length and original length are the same, the object has a scale of 100%.
...
The higher the value, the longer it will be visible even when nearly 90° to the camera, the smaller the value the earlier it will start to vanish.
