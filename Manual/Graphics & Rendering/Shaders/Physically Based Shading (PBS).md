...
There are only two categories of substances which are relevant for calculating physical based shading, which each have special characteristics regarding diffuse and specular reflectance:

- **metals** (conductors like iron, gold, copper, etc.)
- **non-metals** (dielectric materials like plastic, stone, wood, skin, glass, etc.)
