...
**
Create Object → Legacy Entities → Lights → Light
**
.
...
In earlier revisions of CRYENGINE, lights had an option called
**
Negative Light
**
. This system was removed in later revisions because a more solid implementation was introduced into the lighting system.
...
**
Create Object → Legacy Entities → Lights → DestroyableLight
**
.
