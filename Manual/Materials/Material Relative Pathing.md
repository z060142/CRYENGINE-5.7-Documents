...
- Lets you move the objects together along with the **.mtl* and texture files anywhere within your project directory without breaking the texture paths.
...
[Sections](#sections)[How does it work?](#how-does-it-work)[Asset Optimization](#asset-optimization)
...
```
File="<GameFolder>\objects\architecture\house\textures\house.tif"
```
...
For more information about optimizing your assets, check [here](/docs/static/engines/cryengine-3/categories/1114113/pages/1310836).
