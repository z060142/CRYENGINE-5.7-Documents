...
[Sections](#sections)[Advantages](#advantages)[Disadvantages](#disadvantages)[Conversion](#conversion)[Filter file](#filter-file)
...
In this example, the file 'xmlfilter.txt' is referenced, this file is located in `Bin64\RC\xmlfilter.txt`. This file controls which files are converted, and how.
